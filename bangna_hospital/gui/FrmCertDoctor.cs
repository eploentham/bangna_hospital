...
namespace bangna_hospital.gui
{
    public partial class FrmCertDoctor : Form
    {
        ...
        ,"ความดันโลหิตสูงและเก๊าท์","ไข้หนาวสั่น","โลหิตจางและเวียนศรีษะ","เวียนศรีษะ","กระดูกไหปลาร้าขวาหัก","กระดูกไหปลาร้าซ้ายหัก","ปรึกษาอาการโรคหยุดหายใจขณะหลับ","ปวดบริเวณ","ปวดบริเวณกรามด้านขวา","แผลบริเวณทวารหนัก","เวียนศีรษะและระดับไขมันในเลือดสูง","ขี้หูอุดตัน","กล้ามเนื้อขาอักเลบ","เชื้อราที่ท้อง แขน"
