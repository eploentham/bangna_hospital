...
namespace bangna_hospital.gui
{
    public partial class FrmEpidem : Form
    {
         ...
         */ 
        BangnaControl bc;
        Font fEdit, fEditB, fEdit1, fEdit1B, fPrnBil, famtB14, fEditS;
        EpidemAPIDB epiApiDB;

        C1ThemeController theme1;
        C1FlexGrid grfData, grfBn5, grfBn2;
        ...
        private void BtnBn5SendAPI_Click(object sender, EventArgs e)
        {
            ...
            epiHosp.hospital_code = txtHosp5Code.Text.Trim();
            epiHosp.hospital_name = txtHosp5Name.Text.Trim();
            epiHosp.his_identifier = txtHis5Iden.Text.Trim();
        ...
        private void BtnGenData_Click(object sender, EventArgs e)
        {
            ...
            foreach (Row row in grfData.Rows)
            {
                ...
                if (row[colhosname].ToString().Equals("bangna2") || row[colhosname].ToString().Equals("bangna5"))
                {
                    ...
                    pers.nationality = "";
                    pers.gender = row[colgender].ToString();
                    ...
                    rpt.risk_history_type_id = "";              //ได้เดินทางหรือทำกิจกรรม ในสถานที่ๆ มีคนอยู่หนา                    แน่น Y / N
                    ...
                    rpt.epidem_amp_code = "";       
                    rpt.epidem_tmb_code = "";       
                    rpt.location_gis_latitude = "";         //พิกัด Latitude GIS float value WGS84
                    rpt.location_gis_longitude = "";        //พิกัด Longitude GIS float value WGS84
                    rpt.isolate_chw_code = "";              //รหัสจังหวัดที่ isolate
                    rpt.isolate_place_id = "";              //สถานที่ isolate                     (ตัวเลือกจากตาราง epidem_covid_isolate_place)
                    rpt.patient_type = "";                  //ประเภทผู้ป่วย (OPD / IPD)
                    rpt.epidem_covid_cluster_type_id = "";//รหัสของกลุ่ม cluster (ตัวเลือกจากตาราง epidem_cluster)
                    rpt.cluster_latitude = "";      //พิกัด Latitude GIS float value WGS84 ของ cluster
                    rpt.cluster_longitude = "";     

                    lab.epidem_lab_confirm_type_id = "";        //ผลการตรวจที่ยืนยันการติดเชื้อ                     (1 = RT - PCR, 2 = Antigen,                    3 = Antibody)
                    lab.lab_report_date = "";                   //วันที่รายงานผล LAB                     (ค.ศ.) YYYY - MM - DD
                    lab.lab_report_result = "";                 //ผล lab “negative”, “positive”
                    lab.specimen_date = "";                     //วันที่เก็บตัวอย่าง specimen                    (ค.ศ.) YYYY - MM - DD
                    lab.specimen_place_id = "";                 //รหัสสถานที่เก็บตัวอย่าง (ตัวเลือกจากตาราง epidem_covid_spcm_place)
                    lab.tests_reason_type_id = "";              //เหตุผลการตรวจ  (ตัวเลือกจากตาราง epidem_covid_reason_type)
                    lab.lab_his_ref_code = "";                  //รหัสอ้างอิงฝั่ง HIS
                    lab.lab_his_ref_name = "";                  //ชื่อรายการ Lab ฝั่ง HIS
                    ...
                    if (row[colhosname].ToString().Equals("bangna2") || row[colhosname].ToString().Equals("bangna5"))
                    {
                        ...
                        epiApi.gender = pers.gender;
                        epiApi.birth_date = pers.birth_date;
                        epiApi.age_y = pers.age_y;
                        epiApi.age_m = pers.age_m;
                        epiApi.age_d = pers.age_d;
                        epiApi.marital_status_id = pers.marital_status_id;
                        ...
                        epiApi.epidem_person_status_id = rpt.epidem_person_status_id;
                        epiApi.epidem_symptom_type_id = rpt.epidem_symptom_type_id;
                        epiApi.pregnant_status = rpt.pregnant_status;
                        epiApi.respirator_status = rpt.respirator_status;
                        epiApi.epidem_accommodation_type_id = rpt.epidem_accommodation_type_id;
                        ...
                        epiApi.rick_history_type_id = rpt.risk_history_type_id;
                        ...
                        epiApi.location_gis_latitude = rpt.location_gis_latitude;
                        epiApi.location_gis_longitude = rpt.location_gis_longitude;
                        epiApi.isolate_chw_code = rpt.isolate_chw_code;
                        epiApi.isolate_place_id = rpt.isolate_place_id;
                        epiApi.patient_type = rpt.patient_type;
                        epiApi.epidem_covid_cluster_type_id = rpt.epidem_covid_cluster_type_id;
                        epiApi.cluster_latitude = rpt.cluster_latitude;
                        epiApi.cluster_longitude = rpt.cluster_longitude;

                        epiApi.epidem_lab_confirm_type_id = lab.epidem_lab_confirm_type_id;
                        ...
                        epiApi.specimen_place_id = lab.specimen_place_id;
                        epiApi.tests_reason_type_id = lab.tests_reason_type_id;
        ...
        private EpidemAPI getEpidemApiBn5()
        {
            ...
            epiApi.treated_hospital_code = txtBn5RptDate.Text.Trim();
        ...
        private void initGrfBn5()
        {
            ...
            ////grfAdmit.Cols[colhosname].Visible = false;
            //grfBn5.Cols[colcate].Visible = false;
        ...
        private void setControlBn5ByEpi(EpidemAPI epiapi)
        {
            ...
            try
            {
                ...
                txtBn5RptDate.Value = epiapi.treated_hospital_code;
                ...
                bc.setC1Combo(cboBn5Status, epiapi.epidem_person_status_id);
                ...
                txtBn5Lat.Value = epiapi.location_gis_latitude;
                txtBn5Lon.Value = epiapi.location_gis_longitude;
                err = "03";
                //epiapi.isolate_chw_code = cboBn5IsoChw.SelectedItem == null ? "" : ((ComboBoxItem)cboBn5IsoChw.SelectedItem).Value;
                //epiapi.isolate_place_id = cboBn5IsoPlace.SelectedItem == null ? "" : ((ComboBoxItem)cboBn5IsoPlace.SelectedItem).Value;
                //epiapi.patient_type = cboBn5PttType.SelectedItem == null ? "" : ((ComboBoxItem)cboBn5PttType.SelectedItem).Value;
                ...
                txtBn5ClusterLat.Value = epiapi.cluster_latitude;
                txtBn5ClusterLon.Value = epiapi.cluster_longitude;
        ...
        private void setControlBn5New(int rownum)
        {
            ...
            try
            {
                ...
                bc.setC1ComboByName(cboBn5Status, row[colRptPers].ToString());
                err = "02";
                ...
                txtBn5ClusterLat.Value = row[colRptClusLat] != null ? row[colRptClusLat].ToString() : "";
                txtBn5ClusterLon.Value = row[colRptClusLon] != null ? row[colRptClusLon].ToString() : "";
                txtBn5Lat.Value = row[colRptLat] != null ? row[colRptLat].ToString() : "";
                txtBn5Lon.Value = row[colRptLon] != null ? row[colRptLon].ToString() : "";
                err = "03";
        ...
        private void setGrfData()
        {
            ...
            foreach (DataRow row1 in dt.Rows)
            {
                ...
                //grfAdmit[i, colprov] = row1["prov_name"].ToString();
                grfData[i, 0] = i;
                if (i % 2 == 0)
                {
        ...
        private async void getAuten()
        {
            ...
            bc.epiProv.setCboProvince(cboBn5Chw, lProv, "");
            bc.epiProv.setCboProvince(cboBn5EpidemChw, lProv, "");
