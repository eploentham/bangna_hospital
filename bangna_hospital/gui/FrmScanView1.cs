...
namespace bangna_hospital.gui
{
    ...
    public partial class FrmScanView1 : Form
    {
        ...
        C1DockingTabPage tabEKG, tabDocOLD, tabEST, tabECHO, tabHolter, tabEarEyelung;
        ...
        C1FlexGrid grfPrnEmailImg, grfCertiView, grfEKG, grfDocOLD, grfEST, grfHolter, grfECHO, grfEarEyeLung;
        ...
        Panel pnEKGTop, pnEKGView, pnDocTop, pnDocView,pnECHOTop, pnECHOView, pnESTTop, pnESTView, pnHolterTop, pnHolterView, pnEarEyeLung;
        ...
        Label lbPttSymptom, lbPttVsDate, lbPaidType, lbLoading, lbDocAll, lbDocGrp1, lbDocGrp2, lbDocGrp3, lbDocGrp4, lbDocGrp5, lbDocGrp6, lbDocGrp7, lbDocGrp8, lbDocGrp9, lbItmNum, lbItmPerDay, lbItmNumDay;
        ...
        C1TextBox txtItmRowNo, txtItmId, txtItmName, txtItmQty, txtItmFre, txtItmIn1, txtItmIn2, txtPrnEmailTo, txtPrnEmailSubject, txtPrnEmailBody, txtItmFlag,txtItmNum, txtItmPerDay, txtItmNumDay;
        C1Button btnItmSend, btnItmDrugSet, btnItmSave, btnPrnFile, btnPrn, btnSearch, btnCertiNew, btnCertiNew1,btnCerti1View;
        ...
        int colgrfLungVsDate = 1,colgrfLungLeftEar=2, colgrfLungRightEar = 3, colgrfLungLeftEarNormal = 4, colgrfLungRightEarNormal = 5, colgrfLungLeftEarOther = 6, colgrfLungRightEarOther = 7, colgrfLungLeftEye = 8, colgrfLungRightEye = 9, colgrfLungLeftEyePh = 10, colgrfLungRightEyePh = 11, colgrfLungEyeNormal = 12, colgrfLungLungValue = 13, colgrfLungLungNormal = 14;
        ...
        //Control หมอป้อนยา
        C1SplitContainer sCChief, sCDrug;
        C1SplitterPanel cspDrug, cspLab, cspXray, cspProcedure, cspCheif, cspPhysical, cspDiag, cspDtrAdvice;
        PanelElement pnTilesDrug1, pnTilesDrug2, pnTilesDrug3, pnTilesDrug4, pnTilesDrug5, pnTilesDrug6, pnTilesDrug7;
        TextElement txtDrugCode, txtDrugName, txtDrugUsing, txtFrequency, txtPrecautions, txtInteraction, txtIndication;
        C1TileControl TileDrug;
        Group grDrug;
        Template tempRec;
        RichTextBox rtb;
        C1FlexGrid grfTileLab, grfTileXray,grfTileProc;
        //VScrollBar vScroller;
        //int y = 0;
        Form frmImg;
        String dsc_id = "", HN = "", flagShowBtnSearch="", PRENO="",VSDATE = "", docgrpid="", emailSummary="", emailDrug="", emailLab="", emailXray="", DTRCODE = "", CERTI2NDLEAF = "";
        //Timer timer1;
        Patient PTT;
        ...
        Color colorLbDoc;
        Boolean pageLoadGrfPrn = false, fromDoctor=false, VSDTRORD=false;
        AutocompleteMenu acmEmailCsh;
        C1PdfDocumentSource pdsMedCerti, pdsMedCerti2;
        ...
        public FrmScanView1(BangnaControl bc, String dtrcode, String hn, String flagShowBtnSearch)
        {
            //new LogWriter("d", "FrmScanView1 InitializeComponent start");
            InitializeComponent();
            this.bc = bc;
        ...
        {
            //throw new NotImplementedException();
            FrmDoctorOrder frm = new FrmDoctorOrder(bc, DTRCODE, HN, VSDATE, PRENO, PTT);
            frm.Hide();
        ...
        private void initTabDtr()
        {
            ...
            tabDoc = new C1DockingTabPage();
            tabDoc.Location = new System.Drawing.Point(1, 24);
            //tabScan.Name = "c1DockingTabPage1";
            tabDoc.Size = new System.Drawing.Size(667, 175);
            tabDoc.TabIndex = 0;
            //tabHn.Text = "Hn เวชระเบียน";
            tabDoc.Text = "Document";
            tabDoc.Name = "tabDoc";
            tcDtr.Controls.Add(tabDoc);
            ...
            tcDoc = new C1DockingTab();
            tcDoc.Dock = System.Windows.Forms.DockStyle.Fill;
            tcDoc.Location = new System.Drawing.Point(0, 266);
            tcDoc.Name = "tcDoc";
            tcDoc.Size = new System.Drawing.Size(669, 200);
            tcDoc.TabIndex = 0;
            tcDoc.TabsSpacing = 5;
            //tcMac.DoubleClick += TcMac_DoubleClick;
            tabDoc.Controls.Add(tcDoc);
            tabEKG = new C1DockingTabPage();
            tabEKG.Location = new System.Drawing.Point(1, 24);
            tabEKG.Size = new System.Drawing.Size(667, 175);
            tabEKG.TabIndex = 0;
            tabEKG.Text = "EKG";
            tabEKG.Name = "tabEKG";
            tcDoc.Controls.Add(tabEKG);

            tabECHO = new C1DockingTabPage();
            tabECHO.Location = new System.Drawing.Point(1, 24);
            tabECHO.Size = new System.Drawing.Size(667, 175);
            tabECHO.TabIndex = 0;
            tabECHO.Text = "ECHO";
            tabECHO.Name = "tabECHO";
            tcDoc.Controls.Add(tabECHO);

            tabEST = new C1DockingTabPage();
            tabEST.Location = new System.Drawing.Point(1, 24);
            tabEST.Size = new System.Drawing.Size(667, 175);
            tabEST.TabIndex = 0;
            tabEST.Text = "EST";
            tabEST.Name = "tabEST";
            tcDoc.Controls.Add(tabEST);

            tabHolter = new C1DockingTabPage();
            tabHolter.Location = new System.Drawing.Point(1, 24);
            tabHolter.Size = new System.Drawing.Size(667, 175);
            tabHolter.TabIndex = 0;
            tabHolter.Text = "Holter";
            tabHolter.Name = "tabHolter";
            tcDoc.Controls.Add(tabHolter);

            tabEarEyelung = new C1DockingTabPage();
            tabEarEyelung.Location = new System.Drawing.Point(1, 24);
            tabEarEyelung.Size = new System.Drawing.Size(667, 175);
            tabEarEyelung.TabIndex = 0;
            tabEarEyelung.Text = "EarEyeLung";
            tabEarEyelung.Name = "tabEarEyelung";
            tcDoc.Controls.Add(tabEarEyelung);

            //tabDocOLD = new C1DockingTabPage();
            tabDocOLD = new C1DockingTabPage();
            tabDocOLD.Location = new System.Drawing.Point(1, 24);
            tabDocOLD.Size = new System.Drawing.Size(667, 175);
            tabDocOLD.TabIndex = 0;
            tabDocOLD.Text = "Document Other Hospital";
            tabDocOLD.Name = "tabDocOLD";
            tcDoc.Controls.Add(tabDocOLD);
            ...
            pnDocView = new Panel();
            pnECHOTop = new Panel();
            pnECHOView = new Panel();
            pnESTTop = new Panel();
            pnESTView = new Panel();
            pnHolterTop = new Panel();
            pnHolterView = new Panel();
            pnEarEyeLung = new Panel();

            pnEKGTop.Dock = DockStyle.Top;
            pnEKGView.Dock = DockStyle.Fill;
            pnDocTop.Dock = DockStyle.Top;
            pnDocView.Dock = DockStyle.Fill;
            pnECHOTop.Dock = DockStyle.Top;
            pnECHOView.Dock = DockStyle.Fill;
            pnESTTop.Dock = DockStyle.Top;
            pnESTView.Dock = DockStyle.Fill;
            pnHolterTop.Dock = DockStyle.Top;
            pnHolterView.Dock = DockStyle.Fill;
            pnEarEyeLung.Dock = DockStyle.Fill;
            tabEKG.Controls.Add(pnEKGView);
            tabEKG.Controls.Add(pnEKGTop);
            tabDocOLD.Controls.Add(pnDocView);
            tabDocOLD.Controls.Add(pnDocTop);
            tabEST.Controls.Add(pnESTView);
            tabEST.Controls.Add(pnESTTop);
            tabECHO.Controls.Add(pnECHOView);
            tabECHO.Controls.Add(pnECHOTop);
            tabHolter.Controls.Add(pnHolterView);
            tabHolter.Controls.Add(pnHolterTop);
            tabEarEyelung.Controls.Add(pnEarEyeLung);
        ...
        private void initGrfHolter()
        {
            ...
            grfHolter.Cols[colgrfOutLabDscHN].Caption = "";
            grfHolter.Cols[colgrfOutLabDscPttName].Caption = "";
            ...
            grfHolter.Cols[colgrfOutLabDscPttName].AllowEditing = false;
        ...
        private void GrfHolter_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    new LogWriter("e", "FrmOPD GrfHolter_Click " + ex.Message);
                    bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfHolter_Click", ex.Message);
                }
            }
            catch (Exception ex)
            {
                new LogWriter("e", "FrmOPD GrfHolter_Click " + ex.Message);
                bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfHolter_Click save  ", ex.Message);
                //lfSbMessage.Text = ex.Message;
            }
        }
        private void setGrfHolter()
        {
            ...
            dt = bc.bcDB.dscDB.selectByHolter(txtHn.Text.Trim());
        ...
        private void initGrfEST()
        {
            ...
            grfEST.Cols[colgrfOutLabDscHN].Caption = "";
            grfEST.Cols[colgrfOutLabDscPttName].Caption = "";
            ...
            grfEST.Click += GrfEST_Click;
            //ContextMenu menuGw = new ContextMenu();
            //menuGw.MenuItems.Add("ต้องการ ยกเลิก", new EventHandler(ContextMenu_voidEKG));
            //grfEKG.ContextMenu = menuGw;
            pnESTTop.Controls.Add(grfEST);
        ...
        private void GrfEST_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    //lfSbMessage.Text = ex.Message;
                    new LogWriter("e", "FrmOPD GrfEST_Click " + ex.Message);
                    bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfEST_Click", ex.Message);
                }
            }
            catch (Exception ex)
            {
                new LogWriter("e", "FrmOPD GrfEST_Click " + ex.Message);
                bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfEST_Click save  ", ex.Message);
                //lfSbMessage.Text = ex.Message;
            }
        }
        private void setGrfEST()
        {
            grfEST.Rows.Count = 1;
            DataTable dt = new DataTable();
            dt = bc.bcDB.dscDB.selectByEST(txtHn.Text.Trim());
            foreach (DataRow row1 in dt.Rows)
            {
        ...
        private void initGrfECHO()
        {
            ...
            grfECHO.Cols[colgrfOutLabDscHN].Caption = "";
            grfECHO.Cols[colgrfOutLabDscPttName].Caption = "";
            ...
            grfECHO.Click += GrfECHO_Click;
            //ContextMenu menuGw = new ContextMenu();
            //menuGw.MenuItems.Add("ต้องการ ยกเลิก", new EventHandler(ContextMenu_voidEKG));
            //grfEKG.ContextMenu = menuGw;
            pnECHOTop.Controls.Add(grfECHO);

            //theme1.SetTheme(grfOPD, "ExpressionDark");
            theme1.SetTheme(grfECHO, bc.iniC.themegrfOpd);
        }

        private void GrfECHO_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            ...
            try
            {
                ...
                {
                    //lfSbMessage.Text = ex.Message;
                    new LogWriter("e", "FrmOPD GrfECHO_Click " + ex.Message);
                    bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfECHO_Click", ex.Message);
                }
            }
            catch (Exception ex)
            {
                new LogWriter("e", "FrmOPD GrfECHO_Click " + ex.Message);
                bc.bcDB.insertLogPage(bc.userId, this.Name, "GrfECHO_Click save  ", ex.Message);
                //lfSbMessage.Text = ex.Message;
            }
        }
        private void setGrfECHO()
        {
            grfECHO.Rows.Count = 1;
            DataTable dt = new DataTable();
            dt = bc.bcDB.dscDB.selectByECHO(txtHn.Text.Trim());
            foreach (DataRow row1 in dt.Rows)
            {
        ...
        private void initGrfEKG()
        {
            ...
            grfEKG.Cols[colgrfOutLabDscHN].Caption = "";
            grfEKG.Cols[colgrfOutLabDscPttName].Caption = "";
            ...
            grfEKG.Click += GrfEKG_Click;
            //ContextMenu menuGw = new ContextMenu();
            //menuGw.MenuItems.Add("ต้องการ ยกเลิก", new EventHandler(ContextMenu_voidEKG));
            //grfEKG.ContextMenu = menuGw;
            pnEKGTop.Controls.Add(grfEKG);

            //theme1.SetTheme(grfOPD, "ExpressionDark");
            theme1.SetTheme(grfEKG, bc.iniC.themegrfOpd);
        }

        private void GrfEKG_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        ...
        private void initGrfDocOLD()
        {
            ...
            grfDocOLD.Click += GrfDocOLD_Click;
            
            pnDocTop.Controls.Add(grfDocOLD);

            //theme1.SetTheme(grfOPD, "ExpressionDark");
            theme1.SetTheme(grfDocOLD, bc.iniC.themegrfOpd);
        }

        private void GrfDocOLD_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        ...
        {
            grfEarEyeLung = new C1FlexGrid();
            grfEarEyeLung.Font = fEdit;
            grfEarEyeLung.Dock = System.Windows.Forms.DockStyle.Fill;
            grfEarEyeLung.Location = new System.Drawing.Point(0, 0);
            grfEarEyeLung.Rows.Count = 1;
            grfEarEyeLung.Cols.Count = 15;

            grfEarEyeLung.Cols[colgrfLungLeftEar].Width = 80;
            grfEarEyeLung.Cols[colgrfLungRightEar].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLeftEarNormal].Width = 80;
            grfEarEyeLung.Cols[colgrfLungRightEarNormal].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLeftEarOther].Width = 80;
            grfEarEyeLung.Cols[colgrfLungRightEarOther].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLeftEye].Width = 80;
            grfEarEyeLung.Cols[colgrfLungRightEye].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLeftEyePh].Width = 80;
            grfEarEyeLung.Cols[colgrfLungRightEyePh].Width = 80;
            grfEarEyeLung.Cols[colgrfLungEyeNormal].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLungValue].Width = 80;
            grfEarEyeLung.Cols[colgrfLungLungNormal].Width = 80;

            grfEarEyeLung.Cols[colgrfLungLeftEar].Caption = "หูซ้าย";
            grfEarEyeLung.Cols[colgrfLungRightEar].Caption = "หูขวา";
            grfEarEyeLung.Cols[colgrfLungLeftEarNormal].Caption = "หูซ้าย";
            grfEarEyeLung.Cols[colgrfLungRightEarNormal].Caption = "หูขวา";
            grfEarEyeLung.Cols[colgrfLungLeftEarOther].Caption = "หูซ้ายอื่นๆ";
            grfEarEyeLung.Cols[colgrfLungRightEarOther].Caption = "หูซ้ายอื่นๆ";
            grfEarEyeLung.Cols[colgrfLungLeftEye].Caption = "ตาซ้าย";
            grfEarEyeLung.Cols[colgrfLungRightEye].Caption = "ตาขวา";
            grfEarEyeLung.Cols[colgrfLungLeftEyePh].Caption = "ตาซ้าย";
            grfEarEyeLung.Cols[colgrfLungRightEyePh].Caption = "ตาขวา";
            grfEarEyeLung.Cols[colgrfLungEyeNormal].Caption = "ตาบอดสี";
            grfEarEyeLung.Cols[colgrfLungLungValue].Caption = "ปอด";
            grfEarEyeLung.Cols[colgrfLungLungNormal].Caption = "ปอดปกติ";

            grfEarEyeLung.Cols[colgrfLungLeftEar].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungRightEar].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLeftEarNormal].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungRightEarNormal].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLeftEarOther].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungRightEarOther].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLeftEye].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungRightEye].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLeftEyePh].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungRightEyePh].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungEyeNormal].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLungValue].AllowEditing = false;
            grfEarEyeLung.Cols[colgrfLungLungNormal].AllowEditing = false;
            grfEarEyeLung.Click += GrfEarEyeLung_Click;
            //ContextMenu menuGw = new ContextMenu();
            //menuGw.MenuItems.Add("ต้องการ ยกเลิก", new EventHandler(ContextMenu_voidEKG));
            //grfEKG.ContextMenu = menuGw;
            pnEarEyeLung.Controls.Add(grfEarEyeLung);

            //theme1.SetTheme(grfOPD, "ExpressionDark");
            theme1.SetTheme(grfEarEyeLung, bc.iniC.themegrfOpd);
        }
        private void setGrfEarEyeLung()
        {
            grfEarEyeLung.Rows.Count = 1;
            DataTable dt = new DataTable();
            dt = bc.bcDB.vsDB.selectEarEyeLung(txtHn.Text.Trim());
            foreach (DataRow row1 in dt.Rows)
            {
                Row rowa = grfEarEyeLung.Rows.Add();
                rowa[colgrfLungVsDate] = row1["MNC_DATE"].ToString();
                rowa[colgrfLungLeftEar] = row1["left_ear"].ToString();
                rowa[colgrfLungRightEar] = row1["right_ear"].ToString();
                rowa[colgrfLungLeftEarNormal] = row1["left_ear_normal"].ToString().Equals("1")? "Normal":"";
                rowa[colgrfLungRightEarNormal] = row1["right_ear_normal"].ToString().Equals("1") ? "Normal" : "";
                rowa[colgrfLungLeftEarOther] = row1["left_ear_other"].ToString();
                rowa[colgrfLungRightEarOther] = row1["right_ear_other"].ToString();
                rowa[colgrfLungLeftEye] = row1["left_eye"].ToString();
                rowa[colgrfLungRightEye] = row1["right_eye"].ToString();
                rowa[colgrfLungLeftEyePh] = row1["left_eye_ph"].ToString();
                rowa[colgrfLungRightEyePh] = row1["right_eye_ph"].ToString();
                rowa[colgrfLungEyeNormal] = row1["eye_normal"].ToString();
                rowa[colgrfLungLungValue] = row1["lung_value"].ToString();
                rowa[colgrfLungLungNormal] = row1["lung_normal"].ToString();
            }
        }
        private void GrfEarEyeLung_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        ...
        private void initComponentTabCerti()
        {
            ...
            pnTabCertiTop = new Panel();
            pnTabCertiBotton = new Panel();
            //lbtxtCertiDocNo = new Label();
            //txtCertiDocNo = new C1TextBox();
            btnCertiNew = new C1Button();
            btnCertiNew1 = new C1Button();
            btnCerti1View = new C1Button();
            ...
            bc.setControlC1Button(ref btnCertiNew1, fEdit, "พิมพ์ใบรับรองแพทย์ ใบที่2", "btnCertiNew", gapX+ btnCertiNew.Width+60, gapY);
            bc.setControlC1Button(ref btnCerti1View, fEdit, "view ใบรับรองแพทย์ ใบที่2", "btnCerti1View", gapX + btnCertiNew.Width + btnCertiNew1.Width + 60, gapY);
            btnCertiNew.Click += BtnCertiNew_Click;
            btnCertiNew1.Click += BtnCertiNew1_Click;
            btnCerti1View.Click += BtnCerti1View_Click;

            pnTabCertiBotton.Controls.Add(fvCerti);
            //pnTabCertiBotton.Controls.Add(txtCertiDocNo);

            pnTabCertiTop.Controls.Add(btnCertiNew);
            pnTabCertiTop.Controls.Add(btnCertiNew1);
            pnTabCertiTop.Controls.Add(btnCerti1View);
            tabCerti.Controls.Add(pnTabCertiBotton);
            tabCerti.Controls.Add(pnTabCertiTop);
            btnCertiNew1.Enabled = false;
            btnCerti1View.Enabled = false;

            theme1.SetTheme(fvCerti, bc.iniC.themeApp);
        }

        private void BtnCerti1View_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            Form frm2ndleaf = new Form();
            MedicalCertificate certi = new MedicalCertificate();
            certi = bc.bcDB.mcertiDB.selectByPk(CERTI2NDLEAF);
            DocScan dsc = new DocScan();
            dsc = bc.bcDB.dscDB.selectByPk(certi.doc_scan_id);
            FtpClient ftpc = new FtpClient(bc.iniC.hostFTP, bc.iniC.userFTP, bc.iniC.passFTP, bc.ftpUsePassive);
            MemoryStream streamCertiDtr = ftpc.download(dsc.folder_ftp + "/" + dsc.image_path.ToString());
            pdsMedCerti2 = new C1PdfDocumentSource();
            pdsMedCerti2.LoadFromStream(streamCertiDtr);
            C1FlexViewer fvCerti2 = new C1FlexViewer();
            fvCerti2.AutoScrollMargin = new System.Drawing.Size(0, 0);
            fvCerti2.AutoScrollMinSize = new System.Drawing.Size(0, 0);
            fvCerti2.Dock = System.Windows.Forms.DockStyle.Fill;
            fvCerti2.Location = new System.Drawing.Point(0, 0);
            fvCerti2.Name = "fvCerti2";
            
            fvCerti2.TabIndex = 0;
            fvCerti2.Ribbon.Minimized = true;
            fvCerti2.DocumentSource = pdsMedCerti2;
            pnTabCertiBotton.Controls.Add(fvCerti2);
            frm2ndleaf.Controls.Add(fvCerti2);
            frm2ndleaf.StartPosition = FormStartPosition.CenterScreen;
            frm2ndleaf.Size = new Size(850, 700);
            frm2ndleaf.ShowDialog(this);
        }
        private void BtnCertiNew1_Click(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
            new LogWriter("d", this.Name+" BtnCertiNew1_Click DTRCODE " + DTRCODE + " hn " + HN + " vsDate " + VSDATE + " preno " + PRENO+ " 2NFLEAF");
            if (bc.iniC.hostname.Equals("โรงพยาบาล บางนา5"))
            {
                FrmCertDoctor frm = new FrmCertDoctor(bc, DTRCODE, HN, VSDATE, PRENO, "2NFLEAF");
                frm.ShowDialog(this);

                if (frm.streamCertiDtr != null)
                {
                    pnTabCertiBotton.Controls.Clear();
                    pnTabCertiBotton.Controls.Add(fvCerti);
                    C1PdfDocumentSource pds = new C1PdfDocumentSource();
                    ...
                    pds.Print();
                    hideLbLoading();
                    new LogWriter("d", "FrmScanView1 BtnCertiNew1_Click Print Done ");
                }
            }
            else if (bc.iniC.hostname.Equals("โรงพยาบาล บางนา1"))
            {
                FrmCertDoctorBn1 frm = new FrmCertDoctorBn1(bc, DTRCODE, HN, VSDATE, PRENO, "2NFLEAF");
                frm.ShowDialog(this);
        ...
        {
            //throw new NotImplementedException();
            new LogWriter("d", "FrmScanView1 BtnCertiNew_Click DTRCODE "+ DTRCODE+ " hn " + HN+ " vsDate " + VSDATE+ " preno " + PRENO);
            if (bc.iniC.hostname.Equals("โรงพยาบาล บางนา5"))
            {
                FrmCertDoctor frm = new FrmCertDoctor(bc, DTRCODE, HN, VSDATE, PRENO);
                frm.ShowDialog(this);
            ...
            {
                FrmCertDoctorBn1 frm = new FrmCertDoctorBn1(bc, DTRCODE, HN, VSDATE, PRENO);
                frm.ShowDialog(this);
        ...
        private void initGrfOrderLabXray()
        {
            ...
            //grfOrder.Cols[colOrderQty].DataType = typeof(int);
            //grfOrder.Cols[colOrderQty].DataType = typeof(int);
            ...
            grfLab.Name = "grfLab";
            ContextMenu menuGw = new ContextMenu();
            menuGw.MenuItems.Add("Print LAB ", new EventHandler(ContextMenu_print_lab));
            menuGw.MenuItems.Add("Export LAB ", new EventHandler(ContextMenu_print_lab_export));
            menuGw.MenuItems.Add("Print LAB ทุกใบยา ", new EventHandler(ContextMenu_print_lab_allvisit));
            menuGw.MenuItems.Add("Export PDF ทุกใบยา", new EventHandler(ContextMenu_print_lab_export_allvisit));
        ...
        private void setActive()
        {
            ...
            else if (tcDtr.SelectedTab == tabLab)
            {
                ...
                setGrfLab(grfLab, chkIPD.Checked, "", "", "", true);
            ...
            else if (tcDtr.SelectedTab == tabXray)
            {
                ...
                setGrfXray(grfXray, chkIPD.Checked, grfOPD.Row,"","","");
            ...
            else if (tcDtr.SelectedTab == tabCerti)
            {
                ...
                btnCerti1View.Enabled = false;
                cert2ndleaf = bc.bcDB.mcertiDB.selectCertIDByHn2ndLeaf(txtHn.Text.Trim(), PRENO, VSDATE);
                CERTI2NDLEAF = cert2ndleaf;
                btnCertiNew1.Enabled = dsc.doc_scan_id.Length > 0 ? true : false;
                btnCerti1View.Enabled = cert2ndleaf.Length>0 ? true:false;
                FtpClient ftpc = new FtpClient(bc.iniC.hostFTP, bc.iniC.userFTP, bc.iniC.passFTP, bc.ftpUsePassive);
                MemoryStream streamCertiDtr = ftpc.download(dsc.folder_ftp + "/" + dsc.image_path.ToString());
                pnTabCertiBotton.Controls.Clear();
                if (dsc.image_path.ToLower().IndexOf("pdf")>0)
                ...
                else
                {
                    ...
                    pnTabCertiBotton.Controls.Add(certiView);
                }
            ...
            else if (tcDtr.SelectedTab == tabDocOLD)
            {

            }
            else if (tcDtr.SelectedTab == tabDoc)
            {

            }
        }
        private Boolean setControlDoctorOrder()
        {
            Boolean re = true;
            ...
            if (VSDTRORD)
            {
                initControlDoctorOrder();
                setControlDoctorOrder(VSDATE, PRENO);
            }
            else
            {
                //initControlDoctorOrder();
        ...
        private void ContextMenu_CertiMedical_Download(object sender, System.EventArgs e)
        {
            ...
            Image.FromStream(streamPrint).Save(patheName + ((Control)this.txtHn).Text.Trim() + "_" + str2 + ".jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
            this.bc.ExploreFile(patheName + ((Control)this.txtHn).Text.Trim() + "_" + str2 + ".jpg");
        }
        ...
        private void initPicStaffNote()
        {
            this.SuspendLayout();
            tabStfNote.SuspendLayout();
            tabStfNote.Controls.Clear();
        ...
        private void initRichTextChief()
        {
            ...
            cspCheif.Controls.Add(rtbCheif);
        }
        private void initRichTextPhysical()
        {
            ...
            cspPhysical.Controls.Add(rtbPhysical);
        }
        ...
        private void initRichTextDtrAdvice()
        {
            ...
            cspDtrAdvice.Controls.Add(rtbDtrAdvice);
        }
        private void initTileDrug()
        {
            txtDrugCode = new C1.Win.C1Tile.TextElement();
            txtDrugName = new C1.Win.C1Tile.TextElement();
            txtDrugUsing = new C1.Win.C1Tile.TextElement();
            txtFrequency = new C1.Win.C1Tile.TextElement();
            txtPrecautions = new C1.Win.C1Tile.TextElement();
            txtInteraction = new C1.Win.C1Tile.TextElement();
            txtIndication = new C1.Win.C1Tile.TextElement();

            txtDrugCode.TextSelector = C1.Win.C1Tile.TextSelector.Text1;
            txtDrugName.TextSelector = C1.Win.C1Tile.TextSelector.Text2;
            txtDrugUsing.TextSelector = C1.Win.C1Tile.TextSelector.Text3;
            txtFrequency.TextSelector = C1.Win.C1Tile.TextSelector.Text4;
            txtPrecautions.TextSelector = C1.Win.C1Tile.TextSelector.Text5;
            txtInteraction.TextSelector = C1.Win.C1Tile.TextSelector.Text6;
            txtIndication.TextSelector = C1.Win.C1Tile.TextSelector.Text7;

            tempRec = new C1.Win.C1Tile.Template();

            pnTilesDrug1 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug1.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug1.ChildSpacing = 0;
            pnTilesDrug1.Dock = DockStyle.Top;
            pnTilesDrug1.Margin = new System.Windows.Forms.Padding(0);
            pnTilesDrug2 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug2.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug2.ChildSpacing = 0;
            pnTilesDrug2.Dock = DockStyle.Top;
            pnTilesDrug2.Margin = new System.Windows.Forms.Padding(0);
            pnTilesDrug3 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug3.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug3.Margin = new System.Windows.Forms.Padding(0);
            pnTilesDrug3.Dock = DockStyle.Top;
            pnTilesDrug4 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug4.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug4.Dock = DockStyle.Top;
            pnTilesDrug5 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug5.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug5.Dock = DockStyle.Top;
            pnTilesDrug6 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug6.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug6.Dock = DockStyle.Top;
            pnTilesDrug7 = new C1.Win.C1Tile.PanelElement();
            pnTilesDrug7.Alignment = System.Drawing.ContentAlignment.TopLeft;
            pnTilesDrug7.Dock = DockStyle.Bottom;
            //pnTopTilesLab.Children.Add(imgTopTilesLab);
            pnTilesDrug1.Children.Add(txtDrugCode);
            pnTilesDrug2.Children.Add(txtDrugName);
            pnTilesDrug3.Children.Add(txtDrugUsing);
            pnTilesDrug4.Children.Add(txtFrequency);
            pnTilesDrug5.Children.Add(txtPrecautions);
            pnTilesDrug6.Children.Add(txtInteraction);
            pnTilesDrug7.Children.Add(txtIndication);

            // Reduce vertical spacing between tile elements
            //pnTilesDrug1.ChildSpacing = 0;
            //pnTilesDrug2.ChildSpacing = 1;
            //pnTilesDrug3.ChildSpacing = 1;
            //pnTilesDrug4.ChildSpacing = 1;
            //pnTilesDrug5.ChildSpacing = 1;
            //pnTilesDrug6.ChildSpacing = 1;
            //pnTilesDrug7.ChildSpacing = 1;

            //pnTilesDrug1.Padding = new System.Windows.Forms.Padding(0, 0, 0, 0);
            //pnTilesDrug2.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);
            //pnTilesDrug3.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);
            //pnTilesDrug4.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);
            //pnTilesDrug5.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);
            //pnTilesDrug6.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);

            //pnTilesDrug7.Padding = new System.Windows.Forms.Padding(0, 1, 0, 0);

            tempRec.Elements.Add(pnTilesDrug1);
            tempRec.Elements.Add(pnTilesDrug2);
            tempRec.Elements.Add(pnTilesDrug3);
            tempRec.Elements.Add(pnTilesDrug4);
            tempRec.Elements.Add(pnTilesDrug5);
            tempRec.Elements.Add(pnTilesDrug6);
            tempRec.Elements.Add(pnTilesDrug7);

            TileDrug = new C1TileControl();
            TileDrug.Dock = DockStyle.Fill;
            TileDrug.Templates.Add(tempRec);
            TileDrug.Font = fEdit;
            TileDrug.Orientation = LayoutOrientation.Vertical;
            TileDrug.ScrollOffset = 0;
            TileDrug.CellSpacing = 1; // Reduce cell spacing
            TileDrug.SurfaceContentAlignment = System.Drawing.ContentAlignment.TopLeft;
            TileDrug.Padding = new System.Windows.Forms.Padding(0);
            TileDrug.GroupPadding = new System.Windows.Forms.Padding(0);
            grDrug = new Group();
            TileDrug.Groups.Add(this.grDrug);

            cspDrug.Controls.Add(TileDrug);

            grfTileLab = new C1FlexGrid();
            grfTileLab.Font = fEdit;
            grfTileLab.Dock = System.Windows.Forms.DockStyle.Fill;
            grfTileLab.Location = new System.Drawing.Point(0, 0);
            //grfLab.Rows[0].Visible = false;
            //grfLab.Cols[0].Visible = false;
            grfTileLab.Name = "grfTileLab";
            cspLab.Controls.Add(grfTileLab);
            theme1.SetTheme(grfTileLab, bc.iniC.themeApp);
            grfTileXray = new C1FlexGrid();
            grfTileXray.Font = fEdit;
            grfTileXray.Dock = System.Windows.Forms.DockStyle.Top;
            grfTileXray.Location = new System.Drawing.Point(0, 0);
            grfTileXray.Height = 120;
            grfTileXray.Click += GrfXray_Click;
            //grfLab.Cols[0].Visible = false;
            grfTileXray.Name = "grfTileXray";
            grfTileXray.Rows.Count = 1;
            cspXray.Controls.Add(grfTileXray);
            theme1.SetTheme(grfTileXray, bc.iniC.themeApp);
            initGrfProcedure();
        }
        private void initGrfProcedure()
        {
            grfTileProc = new C1FlexGrid();
            grfTileProc.Font = fEdit;
            grfTileProc.Dock = System.Windows.Forms.DockStyle.Fill;
            grfTileProc.Location = new System.Drawing.Point(0, 0);
            grfTileProc.Rows.Count = 1;
            grfTileProc.Cols.Count = 5;
            grfTileProc.Cols[colProcCode].Width = 100;
            grfTileProc.Cols[colProcName].Width = 200;
            grfTileProc.Cols[colProcReqDate].Width = 100;
            grfTileProc.Cols[colProcReqTime].Width = 200;

            grfTileProc.ShowCursor = true;
            grfTileProc.Cols[colProcCode].Caption = "CODE";
            grfTileProc.Cols[colProcName].Caption = "Procedure Name";
            grfTileProc.Cols[colProcReqDate].Caption = "req date";
            grfTileProc.Cols[colProcReqTime].Caption = "req time";

            //grfOperList.Cols[colgrfOperListPaidName].Caption = "นายจ้าง";
            grfTileProc.Cols[colProcCode].DataType = typeof(String);
            grfTileProc.Cols[colProcName].DataType = typeof(String);
            grfTileProc.Cols[colProcReqDate].DataType = typeof(String);
            grfTileProc.Cols[colProcReqTime].DataType = typeof(String);

            grfTileProc.Cols[colProcCode].TextAlign = TextAlignEnum.CenterCenter;
            grfTileProc.Cols[colProcName].TextAlign = TextAlignEnum.LeftCenter;
            grfTileProc.Cols[colProcReqDate].TextAlign = TextAlignEnum.CenterCenter;
            grfTileProc.Cols[colProcReqTime].TextAlign = TextAlignEnum.CenterCenter;

            grfTileProc.Cols[colProcCode].Visible = true;
            grfTileProc.Cols[colProcName].Visible = true;
            grfTileProc.Cols[colProcReqTime].Visible = false;

            grfTileProc.Cols[colProcCode].AllowEditing = false;
            grfTileProc.Cols[colProcName].AllowEditing = false;
            grfTileProc.Cols[colProcReqDate].AllowEditing = false;
            grfTileProc.Cols[colProcReqTime].AllowEditing = false;

            cspProcedure.Controls.Add(grfTileProc);
            theme1.SetTheme(grfTileProc, "Office2010Red");
        }
        private void setGrfProcedure(ref C1FlexGrid grf,String hn, String vsDate, String preno )
        {
            DataTable dt = new DataTable();
            String vn = "", vsdate = "", an = "";
        ...
        private void initControlDoctorOrder()
        {
            String err = "";
            this.SuspendLayout();
            tabStfNote.Hide();
            ...
            try
            {
                ...
                cspL.SizeRatio = 49.855D;
                cspL.TabIndex = 0;
                cspL.Text = "Chielf Compliant1111";
                cspL.Width = 600;
                err = "01";
                cspR = new C1SplitterPanel();
                //cspR.Controls.Add(this.panel2);
                cspR.Height = 629;
                cspR.Dock = C1.Win.C1SplitContainer.PanelDockStyle.Right;
                cspR.Location = new System.Drawing.Point(494, 21);
                cspR.Name = "cspR";
                cspR.Size = new System.Drawing.Size(600, 608);
                cspR.TabIndex = 1;
                cspR.Text = "Drug/Lab/Procedure";

                sct.Panels.Add(cspL);
                sct.Panels.Add(cspR);
                err = "02";
                sCChief = new C1SplitContainer();
                sCChief.Dock = DockStyle.Fill;
                sCChief.AutoSizeElement = C1.Framework.AutoSizeElement.Both;
                theme1.SetTheme(sCChief, bc.iniC.themeApplication);
                //sCChief.HeaderHeight = 20;
                cspL.Controls.Add(sCChief);

                sCDrug = new C1SplitContainer();
                sCDrug.Dock = DockStyle.Fill;
                sCDrug.AutoSizeElement = C1.Framework.AutoSizeElement.Both;
                theme1.SetTheme(sCDrug, bc.iniC.themeApplication);
                //sCDrug.HeaderHeight = 0;
                cspR.Controls.Add(sCDrug);
                err = "03";
                cspCheif = new C1SplitterPanel();
                cspCheif.Collapsible = true;
                cspCheif.Dock = C1.Win.C1SplitContainer.PanelDockStyle.Top;
                cspCheif.Location = new System.Drawing.Point(0, 21);
                cspCheif.Name = "cspCheif";
                //cspCheif.Size = new System.Drawing.Size(600, 608);
                cspCheif.SizeRatio = 30;
                cspCheif.TabIndex = 0;
                cspCheif.Text = "Chielf Compliant";
                sCChief.Panels.Add(cspCheif);
                initRichTextChief();
                cspPhysical = new C1SplitterPanel();
                cspPhysical.Collapsible = true;
                cspPhysical.Dock = C1.Win.C1SplitContainer.PanelDockStyle.Top;
                cspPhysical.Location = new System.Drawing.Point(0, 21);
                cspPhysical.Name = "cspPhysical";
                //cspPhysical.Size = new System.Drawing.Size(600, 608);
                cspPhysical.SizeRatio = 30;
                cspPhysical.TabIndex = 0;
                cspPhysical.Text = "Physical";
                sCChief.Panels.Add(cspPhysical);
                initRichTextPhysical();
                cspDiag = new C1SplitterPanel();
                cspDiag.Collapsible = true;
                cspDiag.Dock = C1.Win.C1SplitContainer.PanelDockStyle.Bottom;
                cspDiag.Location = new System.Drawing.Point(0, 21);
                cspDiag.Name = "cspDiag";
                //cspDiag.Size = new System.Drawing.Size(600, 608);
                cspDiag.SizeRatio = 30;
                cspDiag.TabIndex = 0;
                cspDiag.Text = "Diagnosis";
                sCChief.Panels.Add(cspDiag);
                initRichTextDiag();
                cspDtrAdvice = new C1SplitterPanel();
                cspDtrAdvice.Collapsible = true;
                cspDtrAdvice.Dock = C1.Win.C1SplitContainer.PanelDockStyle.Bottom;
                cspDtrAdvice.Location = new System.Drawing.Point(0, 21);
                cspDtrAdvice.Name = "cspDtrAdvice";
                //cspDiag.Size = new System.Drawing.Size(600, 608);
                cspDtrAdvice.SizeRatio = 30;
                cspDtrAdvice.TabIndex = 0;
                cspDtrAdvice.Text = "Doctor Advice";
                initRichTextDtrAdvice();
                cspDrug = new C1SplitterPanel();
                cspDrug.Collapsible = true;
                cspDrug.Dock = PanelDockStyle.Top;
                //cspDrug.Height = 629;
                cspDrug.Location = new System.Drawing.Point(0, 21);
                cspDrug.Name = "cspCheif";
                cspDrug.Size = new System.Drawing.Size(600, 608);
                cspDrug.SizeRatio = 49.855D;
                cspDrug.TabIndex = 0;
                cspDrug.Text = "Drug";
                cspDrug.Width = 600;
                sCDrug.Panels.Add(cspDrug);
                err = "04";
                cspLab = new C1SplitterPanel();
                cspLab.Collapsible = true;
                cspLab.Dock = PanelDockStyle.Top;
                //cspLab.Height = 629;
                cspLab.Location = new System.Drawing.Point(0, 21);
                cspLab.Name = "cspLab";
                cspLab.Size = new System.Drawing.Size(600, 608);
                cspLab.SizeRatio = 49.855D;
                cspLab.TabIndex = 0;
                cspLab.Text = "Lab";
                //cspLab.Width = 600;
                sCDrug.Panels.Add(cspLab);

                cspXray = new C1SplitterPanel();
                cspXray.Collapsible = true;
                cspXray.Dock = PanelDockStyle.Top;
                //cspXray.Height = 629;
                cspXray.Location = new System.Drawing.Point(0, 21);
                cspXray.Name = "cspXray";
                cspXray.Size = new System.Drawing.Size(600, 608);
                cspXray.SizeRatio = 49.855D;
                cspXray.TabIndex = 0;
                cspXray.Text = "Xray";
                //cspXray.Width = 600;
                sCDrug.Panels.Add(cspXray);
                err = "05";
                cspProcedure = new C1SplitterPanel();
                cspProcedure.Collapsible = true;
                cspProcedure.Dock = PanelDockStyle.Top;
                //cspProcedure.Height = 629;
                cspProcedure.Location = new System.Drawing.Point(0, 21);
                cspProcedure.Name = "cspProcedure";
                cspProcedure.Size = new System.Drawing.Size(600, 608);
                cspProcedure.SizeRatio = 49.855D;
                cspProcedure.TabIndex = 0;
                cspProcedure.Text = "Procedure";
                //cspProcedure.Width = 600;
                sCDrug.Panels.Add(cspProcedure);
                err = "06";
                initTileDrug();
                err = "07";
                setGrfLab(grfTileLab, false, HN, VSDATE, PRENO, false);
                setGrfXray(grfTileXray, false, 0, HN, VSDATE, PRENO);
                setGrfProcedure(ref grfTileProc, HN, VSDATE, PRENO);
            }
            catch(Exception ex)
            {
                err = "99 " + err;
        ...
        private void setTileDrug()
        {
            this.SuspendLayout();
            tabStfNote.SuspendLayout();
            TileDrug.SuspendLayout();
            grDrug.Tiles.Clear();
            Boolean chkReq = false;
            DataTable dt = new DataTable();
            dt = bc.bcDB.vsDB.selectDrugOPD1(HN, PRENO, VSDATE);    //จ่ายยาเรียบร้อย
            if (dt.Rows.Count <= 0)
            {
                //ยังไม่ได้จ่ายยา
                dt = bc.bcDB.pharT02DB.selectReq(HN, VSDATE, PRENO);
                chkReq = true;
            }
            foreach (DataRow dr in dt.Rows)
            {
                Tile tilegrpdrug = new C1.Win.C1Tile.Tile();
                tilegrpdrug.HorizontalSize = 4;
                tilegrpdrug.VerticalSize = 1;
                tilegrpdrug.Template = tempRec;
                grDrug.Tiles.Add(tilegrpdrug);
                //tilegrplab.Template = tempFolder;
                //tilegrplab.Image = imgCorr;
                tilegrpdrug.Text1 = dr["MNC_PH_CD"].ToString() + " " + dr["MNC_PH_TN"].ToString();
                tilegrpdrug.Text2 = dr["using1"].ToString().Length>0 ? dr["using1"].ToString() : "using";
                tilegrpdrug.Text3 = dr["frequency"].ToString().Length > 0 ? dr["frequency"].ToString(): "frequency";
                tilegrpdrug.Text4 = dr["precautions"].ToString().Length > 0 ? dr["precautions"].ToString(): "precautions";
                tilegrpdrug.Text5 = dr["interaction"].ToString().Length > 0 ? dr["interaction"].ToString(): "interaction";
                tilegrpdrug.Text6 = dr["indication"].ToString().Length > 0 ? dr["indication"].ToString(): "indication";
                tilegrpdrug.BackColor = chkReq ? Color.Goldenrod: Color.DimGray;
                tilegrpdrug.Tag = dr;
                //tilegrpdrug.Click += Tilegrpdrug_Click;
            }
            tabStfNote.ResumeLayout();
            TileDrug.ResumeLayout();
            this.ResumeLayout();
        }
        ...
        private void ContextMenu_Delete(object sender, System.EventArgs e)
        {
            ...
            {
                int chk = 0;
                String re = bc.bcDB.dscDB.voidDocScan1(dsc_id, "medrecord");
        ...
        private void GrfOPD_AfterRowColChange(object sender, RangeEventArgs e)
        {
            ...
            try
            {
                ...
                this.VSDATE = grfOPD[grfOPD.Row, colVsVsDate1] != null ? grfOPD[grfOPD.Row, colVsVsDate1].ToString() : "";
                //มาจากหน้าจอ DoctorView และเป็น OPD ให้ update act_no
                if (fromDoctor)
                {
                    //ต้องแก้ ให้ใช้ store procedure  สำคัญมาก que_doctor_opd  แก้ store procedure เรียบร้อย 2024-01-25
                    //bc.bcDB.vsDB.updateActNoDoctor114(this.hn, this.preno, vsDate);
                    //bc.bcDB.sumt03DB.updateSumVnAdd(this.DTRCODE, txtHn.Text, this.preno, vsDate);
                }
                setActive();
        ...
        private String setExportSSOtoFolder()
        {
            ...
            DataTable dtLab2 = new DataTable();
            foreach (Row row in grfPrn.Rows)
            {
                if (row[colPrnSSOchk] == null) continue;
                if (row[colPrnSSOchk].ToString().Equals("True"))
                {
                    ...
                    try
                    {
                        ...
                        //LAB
                        DataTable dtLab = new DataTable();
                        dtLab = setPrintLabPrnSSO(vn, preno, chk+"-"+mm+"-"+dd,"vn");
                        //dtLab2 = setPrintLabPrnSSO(vn, preno, chk + "-" + mm + "-" + dd, "vn");
                        if (dtLab.Rows.Count > 0)
                        {
                            dtLabList.Add(dtLab);
                        }
        ...
        {
            int gapY = 30, gapX = 20, gapLine=0, gapColName=120, lentxtName=340;
            Size size = new Size();
            gapX = 5;
            gapColName = 100;
            ...
            grfOrdItem.Cols[colOrdAddId].Caption = "code";
            ...
            grfOrdItem.Cols[colOrdAddId].Width = 70;
            ...
            grfOrdItem.Cols[colOrdDrugIn1].Visible = false;
            grfOrdItem.Cols[colOrdAddRowNo].Visible = false;
            grfOrdItem.Cols[colOrdAddId].AllowEditing = false;
            ...
            txtItmName.Size = new Size(lentxtName, 20);
            ...
            lbItmNum.Text = "เม็ด";
            lbItmNum.Font = fEdit;
            lbItmNum.Location = new System.Drawing.Point(gapColName, gapLine);
            lbItmNum.AutoSize = true;
            lbItmNum.Name = "lbItmNum";
            txtItmNum = new C1TextBox();
            txtItmNum.Font = fEdit;
            txtItmNum.Name = "txtItmNum";
            txtItmNum.Location = new System.Drawing.Point(lbItmNum.Location.X + 45, lbItmNum.Location.Y);
            txtItmNum.Size = new Size(40, 20);
            txtItmNum.LostFocus += TxtItmNum_LostFocus;
            txtItmNum.Enter += TxtItmNum_Enter;
            txtItmNum.KeyUp += TxtItmNum_KeyUp;
            txtItmNum.KeyPress += TxtItmNum_KeyPress;

            lbItmPerDay = new Label();
            lbItmPerDay.Text = "วันละ/ครั้ง";
            lbItmPerDay.Font = fEdit;
            lbItmPerDay.Location = new System.Drawing.Point(txtItmNum.Location.X + txtItmNum.Width+15, gapLine);
            lbItmPerDay.AutoSize = true;
            lbItmPerDay.Name = "lbItmDay";
            txtItmPerDay = new C1TextBox();
            txtItmPerDay.Font = fEdit;
            txtItmPerDay.Name = "txtItmDay";
            txtItmPerDay.Location = new System.Drawing.Point(lbItmPerDay.Location.X + 75, lbItmNum.Location.Y);
            txtItmPerDay.Size = new Size(40, 20);
            txtItmPerDay.LostFocus += TxtItmDay_LostFocus;
            txtItmPerDay.Enter += TxtItmPerDay_Enter;
            txtItmPerDay.KeyUp += TxtItmPerDay_KeyUp;
            txtItmPerDay.KeyPress += TxtItmPerDay_KeyPress;

            lbItmNumDay = new Label();
            lbItmNumDay.Text = "จน.วัน";
            lbItmNumDay.Font = fEdit;
            lbItmNumDay.Location = new System.Drawing.Point(txtItmPerDay.Location.X + txtItmPerDay.Width + 15, gapLine);
            lbItmNumDay.AutoSize = true;
            lbItmNumDay.Name = "lbItmNumPer";
            txtItmNumDay = new C1TextBox();
            txtItmNumDay.Font = fEdit;
            txtItmNumDay.Name = "txtItmNumPer";
            txtItmNumDay.Location = new System.Drawing.Point(lbItmNumDay.Location.X + 45, lbItmNum.Location.Y);
            txtItmNumDay.Size = new Size(40, 20);
            txtItmNumDay.LostFocus += TxtItmNumPer_LostFocus;
            txtItmNumDay.Enter += TxtItmNumDay_Enter;
            txtItmNumDay.KeyUp += TxtItmNumDay_KeyUp;
            txtItmNumDay.KeyPress += TxtItmNumDay_KeyPress;
            ...
            txtItmFre.Size = new Size(lentxtName, 20);
            ...
            txtItmIn1.Size = new Size(lentxtName, 20);
            ...
            txtItmIn2.Size = new Size(lentxtName, 20);
            ...
            pnscOrdItem.Controls.Add(lbItmPerDay);
            pnscOrdItem.Controls.Add(txtItmPerDay);
            pnscOrdItem.Controls.Add(lbItmNumDay);
            pnscOrdItem.Controls.Add(txtItmNumDay);
            pnscOrdItem.Controls.Add(lbItmNum);
            pnscOrdItem.Controls.Add(txtItmNum);
        ...
        private void TxtItmNumDay_KeyPress(object sender, KeyPressEventArgs e)
        {
            //throw new NotImplementedException();
        ...
        private void TxtItmNumDay_KeyUp(object sender, KeyEventArgs e)
        {
            //throw new NotImplementedException();
            setQty();
        }

        private void TxtItmPerDay_KeyPress(object sender, KeyPressEventArgs e)
        {
            //throw new NotImplementedException();
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && (e.KeyChar != '.'))
            {
        ...
        private void TxtItmPerDay_KeyUp(object sender, KeyEventArgs e)
        {
            //throw new NotImplementedException();
            setQty();
            if (e.KeyCode == Keys.Enter)
        ...
        private void TxtItmNum_KeyPress(object sender, KeyPressEventArgs e)
        {
            //throw new NotImplementedException();
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && (e.KeyChar != '.'))
            {
        ...
        private void TxtItmNum_KeyUp(object sender, KeyEventArgs e)
        {
            //throw new NotImplementedException();
            setQty();
            if (e.KeyCode == Keys.Enter)
        ...
        private void setQty()
        {
            try
            {
                ...
                int.TryParse(txtItmNum.Text, out num);
                int.TryParse(txtItmPerDay.Text, out perday);
                int.TryParse(txtItmNumDay.Text, out numday);
        ...
        private void TxtItmNumDay_Enter(object sender, EventArgs e)
        {
            //throw new NotImplementedException();

        }

        private void TxtItmPerDay_Enter(object sender, EventArgs e)
        {
            //throw new NotImplementedException();

        }

        private void TxtItmNum_Enter(object sender, EventArgs e)
        {
            //throw new NotImplementedException();

        }

        private void TxtItmNum_LostFocus(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        }

        private void TxtItmNumPer_LostFocus(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        }

        private void TxtItmDay_LostFocus(object sender, EventArgs e)
        {
            //throw new NotImplementedException();
        ...
        private void setGrfOrder(DataTable dtOrder)
        {
            ...
            grfOrder.Cols[colOrderFre].Width = 500;
            grfOrder.Cols[colOrderIn1].Width = 350;
        ...
        private void setControlDoctorOrder(String vsDate, String preno)
        {
            DataTable dt = new DataTable();
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                rtbPhysical.Value = dt.Rows[0]["physical_exam"].ToString();
        ...
        private void setGrfXray(C1FlexGrid grfXray, Boolean chkIPD,int row, String hn, String vsdate1, String preno1)
        {
            //ProgressBar pB1 = new ProgressBar();
            //pB1.Location = new System.Drawing.Point(20, 16);
            //pB1.Name = "pB1";
            ...
            DataTable dt = new DataTable();
            String vn = "", preno = "", vsdate = "", an = "";
            if (!chkIPD && vsdate1.Length == 0 && preno1.Length == 0)
            {
                vn = grfOPD[row, colVsVn] != null ? grfOPD[row, colVsVn].ToString() : "";
                preno = grfOPD[row, colVsPreno] != null ? grfOPD[row, colVsPreno].ToString() : "";
                vsdate = grfOPD[row, colVsVsDate] != null ? grfOPD[row, colVsVsDate].ToString() : "";
                an = grfOPD[row, colVsAn] != null ? grfOPD[row, colVsAn].ToString() : "";
                vsdate = bc.datetoDBWin10EN(vsdate.Substring(0,5), "20"+vsdate.Substring(vsdate.Length-2));
                dt = bc.bcDB.vsDB.selectResultXraybyVN1(txtHn.Text, preno, vsdate);
            }
            else if (!chkIPD && vsdate1.Length > 0 && preno1.Length > 0)
            {
                dt = bc.bcDB.vsDB.selectResultXraybyVN1(txtHn.Text, preno1, vsdate1);
            }
            else
            {
        ...
        private void setGrfLab(C1FlexGrid grfLab, Boolean chkIPD, String hn, String vsdate1, String preno1, Boolean showLoading)
        {
            //ProgressBar pB1 = new ProgressBar();
            //pB1.Location = new System.Drawing.Point(20, 16);
            //pB1.Name = "pB1";
            ...
            if (!chkIPD && vsdate1.Length==0 && preno1.Length == 0)
            {
                ...
                dt = bc.bcDB.vsDB.selectLabbyVN2(txtHn.Text, vsdate, preno);
            }
            else if (!chkIPD && vsdate1.Length > 0 && preno1.Length > 0)
            {
                // doctor order
                dt = bc.bcDB.vsDB.selectLabbyVN2(txtHn.Text, vsdate1, preno1);
            }
            else
            {
                vn = grfIPD[grfIPD.Row, colIPDVn] != null ? grfIPD[grfIPD.Row, colIPDVn].ToString() : "";
        ...
        private void setGrfScan()
        {
            ...
            menuGw.MenuItems.Add("ต้องการ Download ภาพทั้งหมด แบบแยกFile", new EventHandler(ContextMenu_grfscan_DownloadAll));
            menuGw.MenuItems.Add("ต้องการ Download ภาพทั้งหมด แบบรวม1File", new EventHandler(ContextMenu_grfscan_DownloadAllOneFile));
        ...
        private void ContextMenu_grfscan_DownloadAllOneFile(object sender, System.EventArgs e)
        {
        ...
        {
            String id = "", datetick = "", folderName="",err="";
            if (grfScan.Col <= 0) return;
            if (grfScan.Row < 0) return;
            if (grfScan.Col == 1)
            {
            ...
            try
            {
                ...
                folderName = txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-")+"_"+DateTime.Now.Ticks.ToString();
                if (!Directory.Exists(bc.iniC.pathDownloadFile + "\\" + folderName))
                {
                    Directory.CreateDirectory(bc.iniC.pathDownloadFile + "\\" + folderName);
                }
                ...
                foreach (listStream lstrmm in lStream)
                {
                    ...
                    //img1.Save(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_" + i + "_re.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
                    //resizedImage.Save(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_" + i + "_re.jpg", System.Drawing.Imaging.ImageFormat.Jpeg);
                    using (var fileStream = new FileStream(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_" + i + ".jpg", FileMode.Create, FileAccess.Write))
                    {
                ...
                if (File.Exists(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_lab.pdf"))
                {
                    ...
                    PdfControl pdfc = new PdfControl();
                    //pdfc.MergeFileslab(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_all.pdf",files);
                    pdfc.MergeFileslab2(bc.iniC.pathDownloadFile + "\\" + folderName + "\\" + txtHn.Text.Trim() + "_" + txtVN.Text.Trim().Replace("/", "-") + "_all.pdf", files);
                    pdfc = null;
                }
                Process.Start("explorer.exe", bc.iniC.pathDownloadFile + "\\" + folderName);
            }
        ...
        private DataTable setPrintLabPrnSSO(String vn,String preno, String vsdate, String flagVN)
        {
            DataTable dt = new DataTable();
            //DataTable dtreq = new DataTable();
            String an = "", xraycode = "", txt1 = "", reqdate = "", reqno = "", dtrname = "", ordname = "", orddetail = "", dtrxrname = "", resdate = "", pttcompname = "", paidname = "", depname = "";
            ...
            {
                dt = bc.bcDB.vsDB.selectLabbyAN(txtHn.Text.Trim(), vn, preno);
                //new LogWriter("d", "*********** FrmScanView1 setPrintLabPrnSSO anyear " + preno + " hn " + txtHn.Text.Trim() + " an " + vn);
            }
        ...
        private void setGrfVsOPD()
        {
            ...
            foreach (DataRow row1 in dt.Rows)
            {
                ...
                rowa[colVsStatusDtrOrd] = row1["status_doctor_order"].ToString();
            }
            //ContextMenu menuGw = new ContextMenu();
            ...
            grfOPD.Cols[colVsStatusDtrOrd].Visible = false;
        ...
        private void FrmScanView1_Load(object sender, EventArgs e)
        {
            ...
            lbLoading.Hide();
            //sC1.HeaderHeight = 0;
            setControlGbPtt();      // set control ใน gbPtt
            //scOrdDiag1.ClientSize = new Size(20, 100);
            //scOrdDiag2.ClientSize = new Size(20, 600);
