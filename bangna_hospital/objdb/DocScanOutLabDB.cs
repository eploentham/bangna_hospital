...
{
    public class DocScanOutLabDB
    {
        public DocScanOutLab dsc;
        ConnectDB conn;
        public List<DocScanOutLab> lDgs;

        public DocScanOutLabDB(ConnectDB c)
        {
            this.conn = c;
            initConfig();
        }
        ...
        {
            dsc = new DocScanOutLab();
            lDgs = new List<DocScanOutLab>();
        ...
        public void getlBsp()
        {
            ...
            {
                DocScanOutLab itm1 = new DocScanOutLab();
        ...
        {
            //DocScanOutLab cop1 = new DocScanOutLab();
            DataTable dt = new DataTable();
            String limit1 = "";
            if (limit.Length > 0)
            {
        ...
        {
            DocScanOutLab docScan = new DocScanOutLab();
        ...
        {
            //DocScanOutLab cop1 = new DocScanOutLab();2022-10-12 11:00:47.050
            DataTable dt = new DataTable();
        ...
        public DocScanOutLab selectByPk(String id)
        {
            DocScanOutLab cop1 = new DocScanOutLab();
            DataTable dt = new DataTable();
            String sql = "select * " +
        ...
        public DocScanOutLab selectByStatusMedicalExamination(String hn, String mlfm, String vsdate, String preno)
        {
            DocScanOutLab cop1 = new DocScanOutLab();
            DataTable dt = new DataTable();
            String sql = "select * " +
        ...
        private void chkNull(DocScanOutLab p)
        {
            long chk = 0;
            int chk1 = 0;
        ...
        public String insertScreenCapture(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public String insertLabOut(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public String insertMed(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public String insertMedicalExamination(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public String insert(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public String update(DocScanOutLab p, String userId)
        {
            String re = "";
            String sql = "";
            int chk = 0;
        ...
        public String insertDocScan(DocScanOutLab p, String userId)
        {
            String re = "";
        ...
        public DocScanOutLab setDocScan(DataTable dt)
        {
            DocScanOutLab dgs1 = new DocScanOutLab();
            if (dt.Rows.Count > 0)
            {
        ...
        public DocScanOutLab setDocGroupScan(DocScanOutLab dgs1)
        {
            dgs1.doc_scan_id = "";
            dgs1.doc_group_id = "";
            dgs1.row_no = "";
        ...
        public DocScanOutLab castDocScan(DocScanOutLab dsc1)
        {
            DocScanOutLab dsc2 = new DocScanOutLab();
        ...
        //    item.Text = "";
        //    c.Items.Add(item);
        //    foreach (DocScanOutLab cus1 in lDgs)
        //    {
        //        item = new ComboBoxItem();
