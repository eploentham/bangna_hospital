...
namespace bangna_hospital.objdb
{
    public class VisitDB
    {
        ...
        public DataTable selectPttinCheckDOE(String datestart, String dateend)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "select PATIENT_T01.mnc_hn_no,patient_m02.MNC_PFIX_DSC as prefix,patient_m01.MNC_FNAME_T, " +
                ...
                " left JOIN dbo.PATIENT_M02 ON dbo.PATIENT_M01.MNC_PFIX_CDT = dbo.PATIENT_M02.MNC_PFIX_CD " +
                "left join dbo.finance_m02 on finance_m02.MNC_FN_TYP_cd = patient_t01.MNC_FN_TYP_cd " +
                " WHERE   PATIENT_T01.MNC_STS <> 'C'  and patient_t01.status_alien_doe ='1' " +
        ...
        public DataTable selectPttinCheckSSO(String datestart, String dateend)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "select PATIENT_T01.mnc_hn_no,patient_m02.MNC_PFIX_DSC as prefix,patient_m01.MNC_FNAME_T, " +
        ...
        public DataTable selectPttinDeptOrderByNameT(String secid, String datestart, String dateend)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "select pt01.mnc_hn_no,patient_m02.MNC_PFIX_DSC as prefix,patient_m01.MNC_FNAME_T, " +
                "patient_m01.MNC_LNAME_T, convert(VARCHAR(20),pt01.MNC_DATE,23) as MNC_DATE, " +
                " " +
                "pt01.MNC_SHIF_MEMO, " +
                "pt01.mnc_pre_no,PATIENT_M01.mnc_cur_tel, MNC_time, " +
                "Case FINANCE_M02.MNC_FN_TYP_DSC " +
                    "When 'ประกันสังคม (บ.1)' Then 'ปกส(บ.1)' " +
                    "When 'ประกันสังคม (บ.2)' Then 'ปกส(บ.2)' " +
                    "When 'ประกันสังคม (บ.5)' Then 'ปกส(บ.5)' " +
                    ...
                    "When '' Then '' " +
                    "Else MNC_FN_TYP_DSC " +
                    "End as MNC_FN_TYP_DSC,pt01.MNC_FN_TYP_CD, pt01.MNC_PRE_NO " +
                    ",isnull(patient_m02.MNC_PFIX_DSC,'') +' ' + isnull(patient_m01.MNC_FNAME_T,'')+' ' + isnull(patient_m01.MNC_LNAME_T,'') as pttfullname " +
                "from  PATIENT_T01 pt01  " +
                " INNER JOIN dbo.PATIENT_M01 ON pt01.MNC_HN_NO = dbo.PATIENT_M01.MNC_HN_NO and pt01.MNC_HN_yr = PATIENT_M01.MNC_HN_yr  " +
                " INNER JOIN dbo.PATIENT_M02 ON dbo.PATIENT_M01.MNC_PFIX_CDT = dbo.PATIENT_M02.MNC_PFIX_CD " +
                "left join dbo.finance_m02 on finance_m02.MNC_FN_TYP_cd = pt01.MNC_FN_TYP_cd " +
                " WHERE   pt01.MNC_STS <> 'C'  and pt01.MNC_SEC_NO ='" + secid + "'  " +
        ...
        public DataTable selectPttinDeptActNo110(String deptid, string secid, String datestart, String dateend)
        {
            ...
            sql = "select ''  AS row_number,pt01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix,m01.MNC_FNAME_T, " +
                ...
                "Case FINANCE_M02.MNC_FN_TYP_DSC " +
                    ...
                    "When 'ลูกหนี้บางนา 1' Then 'ลูกหนี้(บ.1)' " +
                    "When 'บริษัทประกัน' Then 'บ.ประกัน' " +
                    "When 'ลูกหนี้ตรวจสุขภาพประกันสังคม ' Then 'ลูกหนี้.ตส(ปกส)' " +
                    "When '' Then '' " +
                    "When '' Then '' " +
                    "When '' Then '' " +
                    "Else MNC_FN_TYP_DSC " +
                ...
                ",'' as apm_time,'' as apm_date,'' as apmdept,'' as paidname,'' as dtrname, '' as pttname,'' as desc1,pt01.MNC_SEC_NO,pm24.MNC_COM_DSC, '' as apmmake, '' as hn " +  // เอาไว้ออกรายงาน
                "from  PATIENT_T01 pt01  " +
                ...
                " WHERE   pt01.MNC_STS <> 'C'  " + wheredept +
        ...
        public DataTable selectPttActNo131_600PharmacyOK(String deptid, string secid, String datestart, String dateend)
        {
            DataTable dt = new DataTable();
            String sql = "", wheredept = "", wherepharmacyok= " and (" +
                "(pt01.MNC_PHA_FLG = 'A') or (pt01.MNC_PHA_FLG = '' and pt01.MNC_LAB_FLG = 'A' and pt01.MNC_XRA_FLG = 'A')" +
                "or (pt01.MNC_PHA_FLG = '' and pt01.MNC_LAB_FLG = 'A' and pt01.MNC_XRA_FLG = '')" +
                "or (pt01.MNC_PHA_FLG = '' and pt01.MNC_LAB_FLG = '' and pt01.MNC_XRA_FLG = 'A')" +
                ") ";
            if (deptid.Length == 0)
            {
                wheredept = " ";
            ...
            sql = "select ''  AS row_number,pt01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix,m01.MNC_FNAME_T, " +
                ...
                ", isnull(pm02dtr.MNC_PFIX_DSC,'') +' '+ isnull(pm26.MNC_DOT_FNAME,'')+' ' + isnull(pm26.MNC_DOT_LNAME,'') as dtr_name " +
                ",'' as apm_time,'' as apm_date,'' as apmdept,'' as paidname,'' as dtrname, '' as pttname,'' as desc1,pt01.MNC_SEC_NO,pm24.MNC_COM_DSC, '' as apmmake, '' as hn " +  // เอาไว้ออกรายงาน
                ", pt01.MNC_PHA_FLG, pt01.MNC_LAB_FLG, pt01.MNC_XRA_FLG,pt01.MNC_VN_NO,pt01.MNC_VN_SUM,pt01.MNC_VN_SEQ " +
                ", isnull(pt08.MNC_AN_NO, '') as MNC_AN_NO " +
                "from  PATIENT_T01 pt01  " +
                " INNER JOIN PATIENT_M01 m01 ON pt01.MNC_HN_NO = m01.MNC_HN_NO and pt01.MNC_HN_yr = m01.MNC_HN_yr  " +
                " INNER JOIN PATIENT_M02 m02 ON m01.MNC_PFIX_CDT = m02.MNC_PFIX_CD " +
                "left join finance_m02 on finance_m02.MNC_FN_TYP_cd = pt01.MNC_FN_TYP_cd " +
                ...
                " Order By pt01.mnc_date , pt01.mnc_OPD_tim  ";
            dt = conn.selectData(sql);
            //new LogWriter("d", "selectPttActNo131_600PharmacyOK " + sql);
            return dt;
        }
        ...
        public DataTable selectPttHiinDept1(String deptid, string secid, String datestart, String dateend)
        {
            ...
            if (secid1.Length > 1)
            {
                wheresec = " and patient_t01.MNC_sec_no in (" + secid + ")   ";
            }
            else
            {
                wheresec = " and patient_t01.MNC_sec_no = '" + secid + "' and patient_t01.MNC_DEP_NO = '" + deptid + "' ";
            }
            sql = "select PATIENT_T01.mnc_hn_no,patient_m02.MNC_PFIX_DSC as prefix,patient_m01.MNC_FNAME_T, " +
                "patient_m01.MNC_LNAME_T, convert(VARCHAR(20),PATIENT_T01.MNC_DATE,23) as MNC_DATE, " +
                " " +
                ...
                "left join dbo.finance_m02 on finance_m02.MNC_FN_TYP_cd = patient_t01.MNC_FN_TYP_cd " +
                //"inner join bn5_scan.dbo.t_patient_hi ptthi on PATIENT_T01.MNC_HN_NO = ptthi.hn and convert(VARCHAR(20),PATIENT_T01.mnc_date,23) = ptthi.visit_date and PATIENT_T01.mnc_pre_no = ptthi.pre_no " +
                " WHERE   PATIENT_T01.MNC_STS <> 'C'  "+wheresec+
                " and patient_t01.mnc_date >= '" + datestart + "' and patient_t01.mnc_date <= '" + dateend + "' " +
                " Order By PATIENT_T01.mnc_date, PATIENT_T01.mnc_time ";
            dt = conn.selectData(sql);
        ...
        public DataTable selectPtt(String hn, string paidcode, String datestart, String dateend)
        {
            ...
            sql = "select PATIENT_T01.mnc_hn_no,patient_m02.MNC_PFIX_DSC as prefix,patient_m01.MNC_FNAME_T, " +
                ...
                ",patient_t01.MNC_SHIF_MEMO,patient_t01.MNC_TIME, " +
                "PATIENT_T01.mnc_pre_no,PATIENT_M01.mnc_cur_tel, MNC_time, " +
                "Case FINANCE_M02.MNC_FN_TYP_DSC " +
                    "When 'ประกันสังคม (บ.1)' Then 'ปกส(บ.1)' " +
                    "When 'ประกันสังคม (บ.2)' Then 'ปกส(บ.2)' " +
        ...
        public DataTable selectVisitByHn6(String hn, String flag)
        {
            ...
            sql = "Select   t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                ",pm02dtr.MNC_PFIX_DSC + ' ' + pm26dtr.MNC_DOT_FNAME + ' ' + pm26dtr.MNC_DOT_LNAME as dtr_name, pm32.MNC_MD_DEP_DSC  " +
                ",isnull(pt011.status_doctor_order,'') as  status_doctor_order " +
                "From patient_t01 t01 " +
                " inner join patient_m01 m01 on t01.MNC_HN_NO = m01.MNC_HN_NO " +
                " left join patient_m02 m02 on m01.MNC_PFIX_CDT =m02.MNC_PFIX_CD " +
                " inner join FINANCE_M02 f02 ON t01.MNC_FN_TYP_CD = f02.MNC_FN_TYP_CD " +
                ...
                " left join patient_m02 pm02dtr on pm26dtr.MNC_DOT_PFIX = pm02dtr.MNC_PFIX_CD " +
                " Left Join  PATIENT_M32 pm32 on pm26dtr.MNC_DEP_NO = pm32.MNC_MD_DEP_NO and pm32.MNC_TYP_PT = 'O' and pm26dtr.MNC_SEC_NO  = pm32.MNC_SEC_NO  " +
                //ต้องเชื่อม เพราะ หมอป้อนยาใน t01_1
                " inner join PATIENT_T01_1 pt011 on  t01.MNC_HN_NO = pt011.MNC_HN_NO and t01.MNC_PRE_NO = pt011.MNC_PRE_NO and t01.MNC_DATE = pt011.MNC_DATE " +
                " Where t01.MNC_HN_NO = '" + hn + "' " 
                //+"and t01.MNC_STS <> 'C'  " 
                + whereflag +
                " Order by t01.MNC_HN_NO, t01.mnc_date desc ";
        ...
        public DataTable selectVisitByDatePaidType(String hn,String paidtype, String datestart, String dateend)
        {
            ...
            sql = "Select   t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                "Case f02.MNC_FN_TYP_DSC " +
                    ...
                    "Else MNC_FN_TYP_DSC " +
                    "End as MNC_FN_TYP_DSC, " +
                " t01.MNC_SHIF_MEMO,isnull(t01.MNC_FN_TYP_CD,'') as MNC_FN_TYP_CD, t01.mnc_pre_no, convert(VARCHAR(20),t01.mnc_date,23) as mnc_date, t01.mnc_ref_dsc," +
        ...
        public DataTable selectVisitByHn5(String hn)
        {
            ...
            sql = "Select top 1  t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                " left join patient_m26 pm26 on t01.mnc_dot_cd = pm26.MNC_DOT_CD " +
        ...
        public DataTable selectVisitByHn6(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select top 1  t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
        ...
        public DataTable selectVisitByHn7(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select top 1  t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                "Case f02.MNC_FN_TYP_DSC " +
                    ...
                    "Else MNC_FN_TYP_DSC " +
                    "End as MNC_FN_TYP_DSC, " +
                " t01.MNC_SHIF_MEMO,t01.MNC_FN_TYP_CD, t01.mnc_pre_no, t01.mnc_breath, t01.mnc_high,t01.mnc_bp1_l,t01.mnc_temp,t01.mnc_weight " +
                ", m07.mnc_tum_dsc, m08.mnc_amp_dsc, m09.mnc_chw_dsc, t01.mnc_ratios " +
                ", convert(VARCHAR(20),m01.mnc_bday,23) as mnc_bday, m01.MNC_NAT_CD,m04.MNC_NAT_DSC,m04.MNC_NAT_DSC_e, convert(VARCHAR(20),t01.mnc_date,23) as mnc_date, t01.mnc_time" +
                ", t01.MNC_DOT_CD as doctor_id " +
                ",isnull(pm02dtr.MNC_PFIX_DSC,'')  + ' ' + isnull(pm26.MNC_DOT_FNAME,'')  + ' ' + isnull(pm26.MNC_DOT_LNAME,'')  as dtr_name,isnull(t01.skin_tone,'') as  skin_tone " +
                ",m01.mnc_blo_grp,m01.mnc_blo_rh,t01.MNC_COM_CD, t01.MNC_RES_MAS " +
                "From patient_t01 t01 " +
                " inner join patient_m01 m01 on t01.MNC_HN_NO = m01.MNC_HN_NO " +
                " left join patient_m02 m02 on m01.MNC_PFIX_CDT =m02.MNC_PFIX_CD " +
                " inner join FINANCE_M02 f02 ON t01.MNC_FN_TYP_CD = f02.MNC_FN_TYP_CD " +
        ...
        public DataTable selectVisitByCertId(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select top 1  t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                " t01.MNC_SHIF_MEMO,t01.MNC_FN_TYP_CD, t01.mnc_pre_no, t01.mnc_breath, t01.mnc_high,t01.mnc_bp1_l,t01.mnc_temp,t01.mnc_weight,m01.*, m07.mnc_tum_dsc, m08.mnc_amp_dsc, m09.mnc_chw_dsc, t01.mnc_ratios" +
                ", convert(VARCHAR(20),m01.mnc_bday,23) as mnc_bday, m01.MNC_NAT_CD,m04.MNC_NAT_DSC,m04.MNC_NAT_DSC_e, convert(VARCHAR(20),t01.mnc_date,23) as mnc_date, t01.mnc_time" +
                ", t01.MNC_DOT_CD as doctor_id , t01.MNC_RES_MAS, t01.MNC_COM_CD " +
                ",isnull(pm02dtr.MNC_PFIX_DSC,'')  + ' ' + isnull(pm26.MNC_DOT_FNAME,'')  + ' ' + isnull(pm26.MNC_DOT_LNAME,'')  as dtr_name,isnull(t01.skin_tone,'') as  skin_tone " +
                "From patient_t01 t01 " +
                " inner join patient_m01 m01 on t01.MNC_HN_NO = m01.MNC_HN_NO " +
                " left join patient_m02 m02 on m01.MNC_PFIX_CDT =m02.MNC_PFIX_CD " +
        ...
        public DataTable selectVisitByCertId1(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select top 1  t01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                "Case f02.MNC_FN_TYP_DSC " +
                    ...
                    "Else MNC_FN_TYP_DSC " +
                    "End as MNC_FN_TYP_DSC, " +
                " t01.MNC_SHIF_MEMO,t01.MNC_FN_TYP_CD, t01.mnc_pre_no, t01.mnc_breath, t01.mnc_high,t01.mnc_bp1_l,t01.mnc_temp,t01.mnc_weight, m07.mnc_tum_dsc, m08.mnc_amp_dsc, m09.mnc_chw_dsc, t01.mnc_ratios" +
                ", convert(VARCHAR(20),m01.mnc_bday,23) as mnc_bday, m01.MNC_NAT_CD,m04.MNC_NAT_DSC,m04.MNC_NAT_DSC_e, convert(VARCHAR(20),t01.mnc_date,23) as mnc_date, t01.mnc_time" +
                ", t01.MNC_DOT_CD as doctor_id ,m01.mnc_blo_grp,m01.mnc_blo_rh,t01.MNC_COM_CD, t01.MNC_RES_MAS " +
                ",isnull(pm02dtr.MNC_PFIX_DSC,'')  + ' ' + isnull(pm26.MNC_DOT_FNAME,'')  + ' ' + isnull(pm26.MNC_DOT_LNAME,'')  as dtr_name,isnull(t01.skin_tone,'') as  skin_tone " +
                "From patient_t01 t01 " +
                " inner join patient_m01 m01 on t01.MNC_HN_NO = m01.MNC_HN_NO " +
                " left join patient_m02 m02 on m01.MNC_PFIX_CDT =m02.MNC_PFIX_CD " +
        ...
        public DataTable selectVisitByAn(String hn, String anno, String ancnt)
        {
            DataTable dt = new DataTable();
            String sql = "Select mnc_pre_no, convert(VARCHAR(20),mnc_date,23) as mnc_date  From Patient_t08 Where mnc_hn_no = '" + hn+"' and mnc_an_no = '"+anno+"' and mnc_an_yr = '"+ancnt+"' " ;
            dt = conn.selectData(sql);
            return dt;
        }
        ...
        public DataTable selectCompByPreno(String hn, String visitDate, String preno)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select t01.*,isnull(pm24.MNC_COM_DSC,'') as MNC_COM_DSC ,isnull(pm24.MNC_COM_ADD,'') as MNC_COM_ADD,isnull(mk03.MNC_COM_PRF,'') as MNC_COM_PRF " +
                "From patient_t01 t01 " +
                "Left Join Patient_M24 pm24 on t01.MNC_RES_MAS = pm24.MNC_COM_CD " +
                "Left Join MARKETING_m03 mk03 on pm24.MNC_COM_PRF_CD = mk03.MNC_COM_PRF_CD " +
                " Where t01.MNC_HN_NO = '" + hn + "' " +
                "and t01.MNC_DATE = '" + visitDate + "' " +
                "and t01.MNC_PRE_NO = '" + preno + "'" +
                " Order by t01.MNC_HN_NO ";
        ...
        public DataTable selectByDateStatusDoe(String visitDate)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select t01.MNC_HN_NO, convert(varchar(20), t01.MNC_DATE,23) as MNC_DATE, t01.mnc_pre_no, t01.status_alien_doe, m01.MNC_FNAME_T, m01.MNC_LNAME_T " +
                "From patient_t01 t01 inner join Patient_m01 m01 on t01.mnc_hn_no = m01.MNC_HN_NO " +
                " Where  t01.MNC_DATE = '" + visitDate + "' and t01.status_alien_doe != '0' " +
                " Order by t01.MNC_HN_NO, t01.MNC_PRE_NO ";
            dt = conn.selectData(sql);

            return dt;
        }
        public DataTable selectByvsdateDOE(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
        ...
        public DataTable selectByvsdateDOECertId(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select convert(varchar(20),t01.MNC_DATE,23) as MNC_DATE, t01.MNC_PRE_NO, t01.status_quick_order, t01.MNC_VN_NO, t01.MNC_VN_SEQ, t01.MNC_VN_SUM, t01.MNC_HN_NO,isnull(t01.skin_tone,'') as skin_tone " +
        ...
        public Visit selectByvn(String vnno, String vnseq)
        {
            DataTable dt = new DataTable();
            Visit vs = new Visit();
            String sql = "";
        ...
        public DataTable selectByvsdate(String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select t01.* " +
        ...
        public DataTable selectByvsdate(String hn, String visitDate)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select t01.* " +
                "From patient_t01 t01 " +
                " Where t01.MNC_HN_NO = '" + hn + "' " +
                "and t01.MNC_DATE = '" + visitDate + "' and t01.MNC_STS <> 'C' " +
        ...
        public DataTable selectOrderHotChargeUcepOPDByHn(String hn, String hnyr, String visitdate, String preno)
        {
            ...
            //    "Group By pm30.MNC_SR_DSC, pt16.mnc_sr_cd,pt16.mnc_req_dat,pt16.mnc_stamp_tim,pt16.MNC_SR_PRI,pm30.ucep_code,ft031.mnc_fn_cd " +
            //    "-- Order By pt16.mnc_req_dat,pt16.mnc_stamp_tim, pt16.mnc_sr_cd ";
            // แก้ใหม่ เพราะคิดว่า query ข้อมูลมาไม่ค่อยครบ  31-10-24
            sql = "Select isnull(pm30.MNC_SR_DSC,'') as MNC_SR_DSC, isnull(pt16.mnc_sr_cd,'') as mnc_sr_cd, sum(isnull(pt16.mnc_sr_qty,'0')) as qty     , convert(VARCHAR(20),isnull(pt16.mnc_req_dat,''),23) as mnc_req_dat     " +
                ",isnull(pt16.mnc_stamp_tim,'') as mnc_stamp_tim,isnull(pt16.MNC_SR_PRI,'0') as MNC_SR_PRI,isnull(pm30.ucep_code,'') as ucep_code " +
                ",convert(varchar(20), ft031.MNC_FN_DAT,23) as MNC_FN_DAT,ft031.MNC_FN_TIME,isnull(ft031.MNC_FN_CD,'') as MNC_FN_CD,isnull(ft031.MNC_QTY,'0') as MNC_QTY,isnull(ft031.MNC_FN_AMT,'0') as MNC_FN_AMT,isnull(fn01.MNC_FN_DSCT,'') as MNC_FN_DSCT " +
                " " +
                "from FINANCE_T03 ft031 " +
                "left join FINANCE_M01 fn01 on ft031.MNC_FN_CD = fn01.MNC_FN_CD " +
                "left join patient_t16  pt16 on pt16.MNC_REQ_YR = ft031.MNC_REQ_YR and pt16.MNC_REQ_DAT = ft031.MNC_REQ_DAT and pt16.MNC_REQ_NO = ft031.MNC_REQ_NO   " +
                "LEFT join PATIENT_M30 pm30 on pt16.MNC_SR_CD = pm30.MNC_SR_CD   " +
                "Where  " +
                " ft031.MNC_HN_NO = '" + hn + "'  " +
                //" and pt16.MNC_req_STS = 'a' " +      // ต้อง comment ออกเพราะ ถ้าไม่มีใน patient_t16 ทำให้ดึงข้อมูล ไม่ขึ้น
                " and ft031.MNC_PRE_NO = '" + preno + "' " +
                " and ft031.MNC_DATE ='" + visitdate + "' " +
                "Group By pm30.MNC_SR_DSC, pt16.mnc_sr_cd,pt16.mnc_req_dat,pt16.mnc_stamp_tim,pt16.MNC_SR_PRI " +
                ",pm30.ucep_code,ft031.mnc_fn_cd,ft031.MNC_FN_DAT,ft031.MNC_FN_TIME,ft031.MNC_FN_CD,ft031.MNC_QTY,ft031.MNC_FN_AMT ,fn01.MNC_FN_DSCT ";
        ...
        public DataTable selectDrugOPD1(String hn, String preno, String vsdate)
        {
            DataTable dt = new DataTable();
            String sql = "";
            sql = "Select phart06.MNC_PH_CD, pharmacy_m01.MNC_PH_TN ,sum(phart06.MNC_PH_QTY) as qty    " +
                ", convert(VARCHAR(20),phart05.mnc_req_dat,23) as mnc_req_dat,isnull(phart06.frequency,'') as frequency,isnull(phart06.precautions,'') as precautions,isnull(phart06.interaction,'') as interaction,isnull(phart06.indication,'') as indication,isnull(phart06.using1,'') as using1,PHARMACY_M01.mnc_ph_unt_cd " +
                " " +
                "From PHARMACY_T06 phart06  " +
                "left join PHARMACY_T05 phart05 on phart05.MNC_CFR_NO = phart06.MNC_CFR_NO and phart05.MNC_CFG_DAT = phart06.MNC_CFR_dat  " +
                "left join PHARMACY_M01 on phart06.MNC_PH_CD = pharmacy_m01.MNC_PH_CD  " +
                ...
                "and phart05.MNC_CFR_STS = 'a' " +
                "and phart06.MNC_DOC_CD <> 'RIP' " +
                "Group By phart05.mnc_req_dat, phart06.MNC_PH_CD, pharmacy_m01.MNC_PH_TN ,phart06.frequency, phart06.precautions,phart06.interaction,phart06.indication,phart06.using1,PHARMACY_M01.mnc_ph_unt_cd " +
                "Order By phart05.mnc_req_dat, phart06.MNC_PH_CD ";
        ...
        public DataTable selectICD10ByHn(String hn, String date, String preno)
        {
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public DataTable selectICD9ByHn(String hn, String date, String preno)
        {
            String sql = "";
            DataTable dt = new DataTable();
        ...
        public DataTable selectLabbyDate(String hn, String vsddate, String vsdate1)
        {
            String sql = "";
            DataTable dt = new DataTable();
            //[MNC_LB_GRP_DSC]
            sql = "SELECT LAB_T02.MNC_LB_CD, LAB_M01.MNC_LB_DSC, LAB_T05.MNC_RES_VALUE, LAB_T05.MNC_STS, LAB_T05.MNC_RES, LAB_T05.MNC_RES_UNT, LAB_T05.MNC_LB_RES,convert(VARCHAR(20),lab_t05.mnc_req_dat,23) as mnc_req_dat" +
                ...
                "where  t01.mnc_hn_no = '" + hn + "' " +
                "and t01.MNC_DATE >= '" + vsddate + "'  " +
                "and t01.MNC_DATE <= '" + vsdate1 + "'  " +
                "and LAB_T02.mnc_req_sts <> 'C'  and LAB_T01.mnc_req_sts <> 'C' " +
                " and (LAB_T05.MNC_RES_VALUE <> null or LAB_T05.MNC_RES_VALUE <> 'NULL') " +
                //"and LAB_T05.mnc_lb_res_cd = '02' " +
                //"'ch039', 'ch036', 'ch038', 'se005', 'se038', 'se047', 'ch006', 'ch007', 'ch008', 'ch009', 'se165')) " +
                //"and lab_t05.mnc_res <> '' and LAB_T05.MNC_LAB_PRN = '1' " +
                "Order By lab_t05.MNC_REQ_DAT desc,lab_t05.MNC_REQ_NO,LAB_T05.MNC_LB_CD,lab_t05.MNC_LB_RES_CD ";
            //new LogWriter("d", "selectLabbyVN1 "+ sql);
            dt = conn.selectData(sql);
            return dt;
        }
        /*
         * selectLabbyVN1 -> selectLabbyVN2
         */
        public DataTable selectLabbyVN2(String hn, String vsddate, String preNo)
        {
            String sql = "";
            DataTable dt = new DataTable();
            //[MNC_LB_GRP_DSC]
        ...
        public Visit selectbyPreno(String hn, String preno)
        {
            String sql = "";
            DataTable dt = new DataTable();
            Visit vs = new Visit();
            sql = "Select convert(VARCHAR(20),pt01.MNC_DATE,23) as MNC_DATE, pt01.MNC_HN_NO,pt01.MNC_VN_NO,pt01.MNC_VN_SEQ, pt01.MNC_VN_SUM,pt01.MNC_SHIF_MEMO,pt01.MNC_TIME,pt01.MNC_PRE_NO,pt01.MNC_WEIGHT " +
                ...
                " left join finance_m02 fm02 on pt01.MNC_FN_TYP_CD =fm02.MNC_FN_TYP_CD " +
                " left join PATIENT_M24 pm24 on pt01.MNC_COM_CD =pm24.MNC_COM_CD " +
                " left join PATIENT_T01_1 pt011 on pt01.MNC_HN_NO =pt011.MNC_HN_NO and pt01.MNC_DATE =pt011.MNC_DATE and pt01.MNC_PRE_NO =pt011.MNC_PRE_NO " +
                "where pt01.MNC_date = convert(varchar(20),GETDATE(),23)  " +
        ...
        public Visit selectbyCertID(String certid)
        {
            String sql = "";
            DataTable dt = new DataTable();
            Visit vs = new Visit();
        ...
        public DataTable selectByDate1(String datestart, String dateend, String dtrcode, String deptcode, String secno, String sort1)
        {
            ...
            sql = "Select ''  AS row_number, pt01.MNC_HN_YR, pt01.MNC_HN_NO as hn, convert(varchar(20),pt01.MNC_DATE,23) as MNC_DATE, pt01.MNC_TIME " +
                ",fm02.MNC_FN_TYP_DSC as paidname, " +
                "pt01.MNC_PRE_NO, ptpt0107.MNC_DEP_NO, ppt01t07.MNC_SEC_NO, pt01.MNC_DEPR_NO, pt01.MNC_SECR_NO, " +
                " " +
                " pt01.MNC_DOT_CD, " +
                " " +
                "pt01.MNC_STS, pt01.MNC_FN_TYP_CD,  " +
                " convert(varchar(20), pt01.MNC_STAMP_DAT, 20) as MNC_STAMP_DAT, pt01.MNC_STAMP_TIM, pt01.MNC_SEND_VN, pt01.MNC_VN_SEQ,  " +
                "pt01.MNC_VN_SUM, pm32make.mnc_md_dep_dsc as apmmake  " +
                ...
                "From  PATIENT_T01 pt01 " +
                " inner join patient_m01 m01 on pt01.MNC_HN_NO = m01.MNC_HN_NO " +
                " left join patient_m02 m02 on m01.MNC_PFIX_CDT =m02.MNC_PFIX_CD " +
                //"left join patient_m32 pm32 on pt07.MNC_SECR_NO = pm32.mnc_sec_no and pt07.MNC_DEPR_NO = pm32.mnc_md_dep_no  " +
                "left join patient_m32 pm32make on pt01.MNC_SEC_NO = pm32make.mnc_sec_no and pt01.mnc_dep_no = pm32make.mnc_md_dep_no  " +
                "left join	patient_m26 pm26 on pt01.MNC_DOT_CD = pm26.MNC_DOT_CD " +
                "left JOIN	dbo.PATIENT_M02 as pm02dtr ON pm26.MNC_DOT_PFIX = pm02dtr.MNC_PFIX_CD " +
                "left join Finance_m02 fm02 on pt01.MNC_FN_TYP_CD = fm02.MNC_FN_TYP_CD " +
            " Where pt07.MNC_DATE >= '" + datestart + "' and pt01.MNC_DATE <= '" + dateend + "' " + wheredtr + wheredept +
            "Order By pt01.MNC_DATE " + sort1 + ", pt01.MNC_TIME " + sort1 + " ";
            dt = conn.selectData(conn.connMainHIS, sql);

            return dt;
        }
        public DataTable selectChiefCompliant(String hn, String vsdate, String preno)
        {
            DataTable dt = new DataTable();
            String sql = "", whereAn = "";

            sql = "Select pt011.chief_compliant,pt011.physical_exam,pt011.diagnosis,pt011.doctor_advice " +
            "From PATIENT_T01_1 pt011 " +
            "where pt011.mnc_hn_no = '" + hn + "'  and pt011.mnc_pre_no = '" + preno + "' and pt011.mnc_date = '" + vsdate + "'  ";
            //}
            dt = conn.selectData(sql);
            return dt;
        }
        public String selectStatusDoctorOrder(String hn, String vsdate, String preno)
        {
            DataTable dt = new DataTable();
            String sql = "", re = "";

            sql = "Select isnull(pt011.status_doctor_order,'') as status_doctor_order " +
            "From PATIENT_T01_1 pt011 " +
            "where pt011.mnc_hn_no = '" + hn + "'  and pt011.mnc_pre_no = '" + preno + "' and pt011.mnc_date = '" + vsdate + "'  ";
            //}
            dt = conn.selectData(sql);
            if (dt.Rows.Count > 0)
            {
                re = dt.Rows[0]["status_doctor_order"].ToString();
            }
            return re;
        }
        ...
        public String updateVisitStatusDOEbyCertID(String certid, String statusdoe, String useredit)
        {
            String re = "";
            String sql = "";
            try
            {
                sql = "Update Patient_t01 Set " +
                    "status_alien_doe = '" + statusdoe + "' " +
                    //",certi_id = '" + certid + "' " +
                    ",user_modi = '" + useredit + "' " +
                    ",date_modi = convert(varchar(20),getdate(),121) " +
                    " Where certi_id = '" + certid + "' ";
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            }
            catch (Exception ex)
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateVisitStatusDOEbyCertID sql " + sql + " hn " + certid + " statusdoe " + statusdoe);
                re = sql;
            }
            finally
            {
        ...
        public String updateVisitStatusDOE(String hn, String vsdate, String preno, String statusdoe, String vsnote, String useredit)
        {
            String re = "";
            String sql = "";
            try
            ...
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateVisit sql " + sql + " hn " + hn + " statusdoe " + statusdoe);
                re = sql;
            }
            finally
            {
        ...
        public String updateChiefCompliant(String hn, String vsdate, String preno, String chiefcompliant, String useredit)
        {
            String re = "",sql = "";
            try
            {
                sql = "Update Patient_t01_1 Set " +
                    "chief_compliant = '" + chiefcompliant.Replace("'","''") + "' " +
                    ",user_chief_compliant = '" + useredit + "' " +
                    ",date_chief_compliant = convert(varchar(30),getdate(),121) " +
                    " Where MNC_HN_NO = '" + hn + "' and MNC_DATE = '" + vsdate + "' and MNC_PRE_NO = '" + preno + "' ";
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            }
            catch (Exception ex)
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateChiefCompliant sql " + sql + " hn " + hn + " statusdoe " + chiefcompliant);
                re = sql;
            }
            finally
            {
        ...
        public String updatePhysicalExam(String hn, String vsdate, String preno, String physicalexam, String useredit)
        {
            String re = "", sql = "";
            try
            {
                sql = "Update Patient_t01_1 Set " +
                    "physical_exam = '" + physicalexam.Replace("'", "''") + "' " +
                    ",user_physical_exam = '" + useredit + "' " +
                    ",date_physical_exam = convert(varchar(30),getdate(),121) " +
                    " Where MNC_HN_NO = '" + hn + "' and MNC_DATE = '" + vsdate + "' and MNC_PRE_NO = '" + preno + "' ";
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            }
            catch (Exception ex)
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updatePhysicalExam sql " + sql + " hn " + hn + " statusdoe " + physicalexam);
                re = sql;
            }
            finally
            {
        ...
        public String updateDiagnosis(String hn, String vsdate, String preno, String diagnosis, String useredit)
        {
            String re = "", sql = "";
            try
            {
                sql = "Update Patient_t01_1 Set " +
                    ...
                    ",user_diagnosis = '" + useredit + "' " +
                    ",date_diagnosis = convert(varchar(30),getdate(),121) " +
                    " Where MNC_HN_NO = '" + hn + "' and MNC_DATE = '" + vsdate + "' and MNC_PRE_NO = '" + preno + "' ";
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            }
            catch (Exception ex)
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateDiagnosis sql " + sql + " hn " + hn + " statusdoe " + diagnosis);
                re = sql;
            }
            finally
            {
        ...
        public String updateDoctorAdvice(String hn, String vsdate, String preno, String doctoradvice, String useredit)
        {
            ...
            {
                sql = "Update Patient_t01_1 Set " +
                    "doctor_advice = '" + doctoradvice.Replace("'", "''") + "' " +
                    //",user_diagnosis = '" + useredit + "' " +
                    ",date_doctor_advice = convert(varchar(30),getdate(),121) " +
                    " Where MNC_HN_NO = '" + hn + "' and MNC_DATE = '" + vsdate + "' and MNC_PRE_NO = '" + preno + "' ";
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            }
            catch (Exception ex)
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateDoctorAdvice sql " + sql + " hn " + hn + " statusdoe " + doctoradvice);
                re = sql;
            }
            finally
            {
        ...
        public String insertVisit1(String hn, String paid_id, String symptoms, String secno, String remark, String dtrid, String vstype, String compcode, String isnurcode, String userId)
        {
            ...
            try
            {
                ...
                //conn.comStore.Parameters.AddWithValue("status_doe", statusdoe);
        ...
        {
            String re = "", reL = "", reX = "", reP = "", reC = "", reD = "", reYear="";
            String sql = "";
            try
            {
                conn.comStore = new SqlCommand();
                conn.comStore.Connection = conn.connMainHIS;
                conn.comStore.CommandText = "gen_order_opd";
                conn.comStore.CommandType = CommandType.StoredProcedure;
                conn.comStore.Parameters.AddWithValue("hn_where", hn);
                ...
                SqlParameter retvalD = conn.comStore.Parameters.Add("req_drug_no", SqlDbType.VarChar, 200);
                retvalD.Value = "";
                retvalD.Direction = ParameterDirection.Output;
                SqlParameter retvalL = conn.comStore.Parameters.Add("req_lab_no", SqlDbType.VarChar, 200);
                retvalL.Value = "";
                retvalL.Direction = ParameterDirection.Output;
                SqlParameter retvalX = conn.comStore.Parameters.Add("req_xray_no", SqlDbType.VarChar, 200);
                retvalX.Value = "";
                retvalX.Direction = ParameterDirection.Output;
                SqlParameter retvalP = conn.comStore.Parameters.Add("req_procedure_no", SqlDbType.VarChar, 200);
                retvalP.Value = "";
                retvalP.Direction = ParameterDirection.Output;
                SqlParameter retvalY = conn.comStore.Parameters.Add("req_year", SqlDbType.VarChar, 200);
                retvalY.Value = "";
                retvalY.Direction = ParameterDirection.Output;
                conn.connMainHIS.Open();
                conn.comStore.ExecuteNonQuery();
                //re = (String)conn.comStore.Parameters["row_no1"].Value;
                reL = conn.comStore.Parameters["req_lab_no"].Value == DBNull.Value ? "" : (String)conn.comStore.Parameters["req_lab_no"].Value;
                reX = conn.comStore.Parameters["req_xray_no"].Value == DBNull.Value ? "" : (String)conn.comStore.Parameters["req_xray_no"].Value;
                reP = conn.comStore.Parameters["req_procedure_no"].Value == DBNull.Value ? "" : (String)conn.comStore.Parameters["req_procedure_no"].Value;
                reD = conn.comStore.Parameters["req_drug_no"].Value == DBNull.Value ? "" : (String)conn.comStore.Parameters["req_drug_no"].Value;
                reYear = conn.comStore.Parameters["req_year"].Value == DBNull.Value ? "" : (String)conn.comStore.Parameters["req_year"].Value;
                re = reL + "#" + reX + "#" + reP + "#" + reD + "#" + reYear;
                //if (re.Length > 0)
                //{
                //    String[] res = re.Split('#');
                //    if (res.Length > 3)
        ...
        public DataTable selectCertByPID(String pid)
        {
            ...
            "From PATIENT_T01 pt01 " +
            "inner join patient_m01 pm01 on pt01.mnc_hn_no = pm01.mnc_hn_no " +
            "where pm01.MNC_ID_NO = '" + pid + "'  and pt01.MNC_STS != 'C'  " +
            ...
            , String statuscontrol, String controlyear, String controlremark, String supervisor, String pass_supervisor)
        {
            ...
            {
                chk = updateOrderTemp(id,order_code, name, qty, using1, freq, precau, interac, indica, flag, hn);
            }
            return chk;
        }
        ...
        public String updateOrderTemp(String id, String order_code, String name, String qty, String using1, String freq, String precau, String interac, String indica, String flag, String hn)
        {
            String sql = "", re = "";
            sql = "Update  t_order_temp Set " +
                "flag = '" + flag + "' "+
                ...
                ",interaction = '" + interac.Replace("'", "''") + "' " +
                ",indication = '" + indica.Replace("'", "''") + "' " +
                ",hn = '" + hn + "' " +
                ",using1 = '" + using1.Replace("'", "''") + "' " +
                "where id = '" + id + "' ";
            try
            {
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
        ...
        {
            String sql = "", re = "", mnc_sts="", wherests="";
            DataTable dt = new DataTable();
            sql = "Select MNC_STAFF_STS, MNC_STS, mnc_act_no From PATIENT_T01 Where mnc_hn_no = '" + hn + "' and mnc_date = '" + vsdate + "' and mnc_pre_no ='" + preno + "'";
            dt = conn.selectData(sql);
            if (dt.Rows.Count > 0)
            {
                String mnc_staff_sts = dt.Rows[0]["MNC_STAFF_STS"].ToString();
                mnc_sts = dt.Rows[0]["MNC_STS"].ToString();
                String mnc_act_no = dt.Rows[0]["mnc_act_no"].ToString();
                int.TryParse(mnc_act_no, out int actno);
                if (actno >131)
                {
                    return "Already Close Visit";
                }
            }
            if (!mnc_sts.Equals("F"))            {                wherests = ", MNC_STS = 'O' ";            }
            sql = "update patient_t01 set " +
                ...
                wherests +
                ", MNC_RM_MED_CD= 'OPD06' " +
                ", MNC_OPD_TIM = replace(left(convert(varchar(100),getdate(),108),5),':','') " +
                "Where mnc_hn_no = '" + hn + "' and mnc_date = '" + vsdate + "' and mnc_pre_no ='" + preno + "'";
            try
            {
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
        ...
        public String updateStatusCloseVisit1(String hn, String preno, String vsdate, String userid)
        {
            String sql = "", re = "";
            sql = "update patient_t01 set " +
                "MNC_STAFF_STS = 'A'" +     //แก้ใหม่ เพราะ OPD5  ปิดรับทำการแล้วห้องยา ไม่เห็น ใน tab แรก
            ...
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateStatusCloseVisit1 sql " + sql + " hn " + hn);
            }
            return re;
        }
        public String updateStatusQuickOrder(String hn, String preno, String vsdate)
        {
            String sql = "", re = "";
            sql = "update patient_t01 set " +
                "status_quick_order = '1'" +
                "Where mnc_hn_no = '" + hn + "'  and mnc_date = '" + vsdate + "' and mnc_pre_no ='" + preno + "'";
            try
            {
                re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            ...
            {
                sql = ex.Message + " " + ex.InnerException;
                new LogWriter("e", "updateStatusQuickOrder sql " + sql + " hn " + hn);
            }
            return re;
        }
        ...
        public Visit setVisit(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                vs1.hrate = dt.Rows[0]["MNC_RATIOS"].ToString();
                vs1.rrate = dt.Rows[0]["MNC_BREATH"].ToString();
                ...
                vs1.certi_id = dt.Columns.Contains("certi_id") ? dt.Rows[0]["certi_id"].ToString() : "";
