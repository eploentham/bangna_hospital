    ...
    public class XrayDB
    {
        ...
        public DataTable selectVisitStatusPacsReqByDate(String Date)
        {
            ...
            sql = "Select  xr01.*, xr01.MNC_HN_NO,m02.MNC_PFIX_DSC as prefix, " +
                ...
                " Where xr01.MNC_REQ_DAT = '" + Date + "' and xr01.MNC_REQ_STS = 'A' and xt02.status_pacs = '0' " +
                "Order By xr01.mnc_req_dat, xr01.mnc_req_tim";
            dt = conn.selectData(sql);
            
            return dt;
        }
        public DataTable selectVisitStatusPacsReqByDateTestHN(String Date, String hn)
        {
            DataTable dt = new DataTable();
            String sql = "";
            String[] aa = Date.Split('/');
        ...
        public String updateStatusPACs(String reqno, String reqyr, String xrcode, String xrdate)
        {
            String sql = "", re = "";
            sql = "Update xray_t02 Set status_pacs = '1' " +
                "Where mnc_req_no = '" + reqno + "' and mnc_req_yr = '" + reqyr + "' " +
                "and mnc_xr_cd = '"+xrcode+"' and mnc_req_dat = '"+xrdate+"'";
            re = conn.ExecuteNonQuery(conn.connMainHIS, sql);
            return re;
        }
