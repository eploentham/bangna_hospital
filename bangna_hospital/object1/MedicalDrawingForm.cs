...
{
    public class MedicalDrawingForm : UserControl
    {
        BangnaControl BC;
        String PRENO = "", VSDATE = "", HN = "", DTRCODE = "";
        private DrawingPictureBox drawingBox;
        private Panel toolPanel, pnView;
        private Button penButton, eraserButton, clearButton, saveButton, loadButton;
        ...
        public MedicalDrawingForm(BangnaControl bc, String dtrcode, String hn, String vsdate, String preno, Patient ptt)
        {
            this.BC = bc;
        ...
        private void SetupDrawingInterface()
        {
            ...
            toolPanel.Controls.AddRange(new Control[]
            {
                ...
                colorButton, drawingModeCombo, clearButton, saveButton, loadButton
            });

            drawingBox = new DrawingPictureBox
            {
                Dock = DockStyle.Fill,
        ...
        public void DrawingBoxLoad()
        {
            ...
            DataTable dt = BC.bcDB.dscDB.selectByDoctorOrder(HN, VSDATE, PRENO);
