...
cur = conn.cursor()
sql = "Select top (1000) * From doc_scan where doc_scan_id >= 1000000000 and doc_scan_id <= 1000030000 and status_ml is null and active = '1' and status_record = '1' Order By doc_scan_id"
cur.execute(sql)
